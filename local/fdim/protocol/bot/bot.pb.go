...
type Agent struct {
	...
	Prompts       string                 `protobuf:"bytes,8,opt,name=prompts,proto3" json:"prompts,omitempty"`
...
type UpdateAgentReq struct {
	...
	Identity      *string                `protobuf:"bytes,6,opt,name=identity,proto3,oneof" json:"identity,omitempty"`
	Model         *string                `protobuf:"bytes,7,opt,name=model,proto3,oneof" json:"model,omitempty"`
	Prompts       *string                `protobuf:"bytes,8,opt,name=prompts,proto3,oneof" json:"prompts,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_bot_bot_proto_rawDesc = "" +
	"\n" +
	"\rbot/bot.proto\x12\n" +
	"openim.bot\x1a\x11sdkws/sdkws.proto\"\xe5\x01\n" +
	"\x05Agent\x12\x16\n" +
	...
	"\x05agent\x18\x01 \x01(\v2\x11.openim.bot.AgentR\x05agent\"\x11\n" +
	...
	"\x06agents\x18\x02 \x03(\v2\x11.openim.bot.AgentR\x06agents\"*\n" +
	...
	"\x12SendBotMessageResp2\xfc\x02\n" +
	"\x03bot\x12F\n" +
	"\vCreateAgent\x12\x1a.openim.bot.CreateAgentReq\x1a\x1b.openim.bot.CreateAgentResp\x12F\n" +
	"\vUpdateAgent\x12\x1a.openim.bot.UpdateAgentReq\x1a\x1b.openim.bot.UpdateAgentResp\x12L\n" +
	"\rPageFindAgent\x12\x1c.openim.bot.PageFindAgentReq\x1a\x1d.openim.bot.PageFindAgentResp\x12F\n" +
	"\vDeleteAgent\x12\x1a.openim.bot.DeleteAgentReq\x1a\x1b.openim.bot.DeleteAgentResp\x12O\n" +
	"\x0eSendBotMessage\x12\x1d.openim.bot.SendBotMessageReq\x1a\x1e.openim.bot.SendBotMessageRespB\x13Z\x11fdim/protocol/botb\x06proto3"
