...
//
// "userMaxSeq": It represents the user's upper limit for message retrieval in the user. If not set (default: 0),
// it means the upper limit is the same as the conversation's "maxSeq".
// "userMinSeq": It represents the user's starting point for message retrieval in the user. If not set (default: 0),
...
// "userMinSeq" can be set as the same value as the conversation's "maxSeq" at the moment they join the user.
