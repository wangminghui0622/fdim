...
const (
	...
	User_SearchUserFullInfo_FullMethodName            = "/openim.user.user/searchUserFullInfo"
...
const (
	Group_CreateGroup_FullMethodName                       = "/openim.user.group/createGroup"
	Group_JoinGroup_FullMethodName                         = "/openim.user.group/joinGroup"
	Group_QuitGroup_FullMethodName                         = "/openim.user.group/quitGroup"
	Group_GetGroupsInfo_FullMethodName                     = "/openim.user.group/getGroupsInfo"
	Group_SetGroupInfo_FullMethodName                      = "/openim.user.group/setGroupInfo"
	Group_SetGroupInfoEx_FullMethodName                    = "/openim.user.group/setGroupInfoEx"
	Group_GetGroupApplicationList_FullMethodName           = "/openim.user.group/getGroupApplicationList"
	Group_GetGroupApplicationUnhandledCount_FullMethodName = "/openim.user.group/getGroupApplicationUnhandledCount"
	Group_GetUserReqApplicationList_FullMethodName         = "/openim.user.group/getUserReqApplicationList"
	Group_GetGroupUsersReqApplicationList_FullMethodName   = "/openim.user.group/getGroupUsersReqApplicationList"
	Group_GetSpecifiedUserGroupRequestInfo_FullMethodName  = "/openim.user.group/getSpecifiedUserGroupRequestInfo"
	Group_TransferGroupOwner_FullMethodName                = "/openim.user.group/transferGroupOwner"
	Group_GroupApplicationResponse_FullMethodName          = "/openim.user.group/groupApplicationResponse"
	Group_GetGroupMemberList_FullMethodName                = "/openim.user.group/getGroupMemberList"
	Group_GetGroupMembersInfo_FullMethodName               = "/openim.user.group/getGroupMembersInfo"
	Group_KickGroupMember_FullMethodName                   = "/openim.user.group/kickGroupMember"
	Group_GetJoinedGroupList_FullMethodName                = "/openim.user.group/getJoinedGroupList"
	Group_InviteUserToGroup_FullMethodName                 = "/openim.user.group/inviteUserToGroup"
	Group_GetGroups_FullMethodName                         = "/openim.user.group/getGroups"
	Group_GetGroupMembersCMS_FullMethodName                = "/openim.user.group/getGroupMembersCMS"
	Group_DismissGroup_FullMethodName                      = "/openim.user.group/dismissGroup"
	Group_MuteGroupMember_FullMethodName                   = "/openim.user.group/muteGroupMember"
	Group_CancelMuteGroupMember_FullMethodName             = "/openim.user.group/cancelMuteGroupMember"
	Group_MuteGroup_FullMethodName                         = "/openim.user.group/muteGroup"
	Group_CancelMuteGroup_FullMethodName                   = "/openim.user.group/cancelMuteGroup"
	Group_SetGroupMemberInfo_FullMethodName                = "/openim.user.group/setGroupMemberInfo"
	Group_GetGroupAbstractInfo_FullMethodName              = "/openim.user.group/getGroupAbstractInfo"
	Group_GetUserInGroupMembers_FullMethodName             = "/openim.user.group/getUserInGroupMembers"
	Group_GetGroupMemberUserIDs_FullMethodName             = "/openim.user.group/getGroupMemberUserIDs"
	Group_GetGroupMemberRoleLevel_FullMethodName           = "/openim.user.group/GetGroupMemberRoleLevel"
	Group_GetGroupInfoCache_FullMethodName                 = "/openim.user.group/GetGroupInfoCache"
	Group_GetGroupMemberCache_FullMethodName               = "/openim.user.group/GetGroupMemberCache"
	Group_GroupCreateCount_FullMethodName                  = "/openim.user.group/GroupCreateCount"
	Group_NotificationUserInfoUpdate_FullMethodName        = "/openim.user.group/NotificationUserInfoUpdate"
	Group_GetIncrementalGroupMember_FullMethodName         = "/openim.user.group/getIncrementalGroupMember"
	Group_BatchGetIncrementalGroupMember_FullMethodName    = "/openim.user.group/BatchGetIncrementalGroupMember"
	Group_GetIncrementalJoinGroup_FullMethodName           = "/openim.user.group/getIncrementalJoinGroup"
	Group_GetFullGroupMemberUserIDs_FullMethodName         = "/openim.user.group/GetFullGroupMemberUserIDs"
	Group_GetFullJoinGroupIDs_FullMethodName               = "/openim.user.group/GetFullJoinGroupIDs"
	Group_GetGroupAllMember_FullMethodName                 = "/openim.user.group/getGroupAllMember"
)
...
const (
	Friend_ApplyToAddFriend_FullMethodName               = "/openim.user.friend/applyToAddFriend"
	Friend_GetPaginationFriendsApplyTo_FullMethodName    = "/openim.user.friend/getPaginationFriendsApplyTo"
	Friend_GetPaginationFriendsApplyFrom_FullMethodName  = "/openim.user.friend/getPaginationFriendsApplyFrom"
	Friend_GetSelfUnhandledApplyCount_FullMethodName     = "/openim.user.friend/getSelfUnhandledApplyCount"
	Friend_GetDesignatedFriendsApply_FullMethodName      = "/openim.user.friend/getDesignatedFriendsApply"
	Friend_GetIncrementalFriendsApplyTo_FullMethodName   = "/openim.user.friend/getIncrementalFriendsApplyTo"
	Friend_GetIncrementalFriendsApplyFrom_FullMethodName = "/openim.user.friend/getIncrementalFriendsApplyFrom"
	Friend_AddBlack_FullMethodName                       = "/openim.user.friend/addBlack"
	Friend_RemoveBlack_FullMethodName                    = "/openim.user.friend/removeBlack"
	Friend_IsFriend_FullMethodName                       = "/openim.user.friend/isFriend"
	Friend_IsBlack_FullMethodName                        = "/openim.user.friend/isBlack"
	Friend_GetPaginationBlacks_FullMethodName            = "/openim.user.friend/getPaginationBlacks"
	Friend_GetSpecifiedBlacks_FullMethodName             = "/openim.user.friend/GetSpecifiedBlacks"
	Friend_DeleteFriend_FullMethodName                   = "/openim.user.friend/deleteFriend"
	Friend_RespondFriendApply_FullMethodName             = "/openim.user.friend/respondFriendApply"
	Friend_UpdateFriends_FullMethodName                  = "/openim.user.friend/updateFriends"
	Friend_SetFriendRemark_FullMethodName                = "/openim.user.friend/setFriendRemark"
	Friend_ImportFriends_FullMethodName                  = "/openim.user.friend/importFriends"
	Friend_GetDesignatedFriends_FullMethodName           = "/openim.user.friend/getDesignatedFriends"
	Friend_GetPaginationFriends_FullMethodName           = "/openim.user.friend/getPaginationFriends"
	Friend_GetFriendIDs_FullMethodName                   = "/openim.user.friend/getFriendIDs"
	Friend_GetSpecifiedFriendsInfo_FullMethodName        = "/openim.user.friend/GetSpecifiedFriendsInfo"
	Friend_GetIncrementalFriends_FullMethodName          = "/openim.user.friend/getIncrementalFriends"
	Friend_GetIncrementalBlacks_FullMethodName           = "/openim.user.friend/getIncrementalBlacks"
	Friend_GetFullFriendUserIDs_FullMethodName           = "/openim.user.friend/getFullFriendUserIDs"
	Friend_NotificationUserInfoUpdate_FullMethodName     = "/openim.user.friend/NotificationUserInfoUpdate"
	Friend_GetFriendInfo_FullMethodName                  = "/openim.user.friend/getFriendInfo"
	Friend_GetFriendApplyUnhandledCount_FullMethodName   = "/openim.user.friend/getFriendApplyUnhandledCount"
)
...
var Friend_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "openim.user.friend",
