...
const file_conversation_conversation_proto_rawDesc = "" +
	"\n" +
	"\x1fconversation/conversation.proto\x12\x11fdim.conversation\x1a\x11sdkws/sdkws.proto\x1a\x1bwrapperspb/wrapperspb.proto\"\xc8\x04\n" +
	"\fConversation\x12 \n" +
	...
	"\risMsgDestruct\x18\x11 \x01(\bR\risMsgDestruct\"\x9b\x06\n" +
	...
	"\agroupID\x18\x04 \x01(\tR\agroupID\x129\n" +
	"\n" +
	"recvMsgOpt\x18\x05 \x01(\v2\x19.fdim.protobuf.Int32ValueR\n" +
	"recvMsgOpt\x124\n" +
	"\bisPinned\x18\x06 \x01(\v2\x18.fdim.protobuf.BoolValueR\bisPinned\x12>\n" +
	"\fattachedInfo\x18\a \x01(\v2\x1a.fdim.protobuf.StringValueR\fattachedInfo\x12>\n" +
	"\risPrivateChat\x18\b \x01(\v2\x18.fdim.protobuf.BoolValueR\risPrivateChat\x12*\n" +
	"\x02ex\x18\t \x01(\v2\x1a.fdim.protobuf.StringValueR\x02ex\x12=\n" +
	"\fburnDuration\x18\n" +
	" \x01(\v2\x19.fdim.protobuf.Int32ValueR\fburnDuration\x121\n" +
	"\x06minSeq\x18\v \x01(\v2\x19.fdim.protobuf.Int64ValueR\x06minSeq\x121\n" +
	"\x06maxSeq\x18\f \x01(\v2\x19.fdim.protobuf.Int64ValueR\x06maxSeq\x12;\n" +
	"\vgroupAtType\x18\r \x01(\v2\x19.fdim.protobuf.Int32ValueR\vgroupAtType\x12C\n" +
	"\x0fmsgDestructTime\x18\x0e \x01(\v2\x19.fdim.protobuf.Int64ValueR\x0fmsgDestructTime\x12>\n" +
	"\risMsgDestruct\x18\x0f \x01(\v2\x18.fdim.protobuf.BoolValueR\risMsgDestruct\"Y\n" +
	"\x12SetConversationReq\x12C\n" +
	"\fconversation\x18\x01 \x01(\v2\x1f.fdim.conversation.ConversationR\fconversation\"\x15\n" +
	"\x13SetConversationResp\"^\n" +
	"\x12GetConversationReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12 \n" +
	"\vownerUserID\x18\x02 \x01(\tR\vownerUserID\"Z\n" +
	"\x13GetConversationResp\x12C\n" +
	"\fconversation\x18\x02 \x01(\v2\x1f.fdim.conversation.ConversationR\fconversation\"\x9f\x01\n" +
	...
	"\vunreadTotal\x18\x02 \x01(\x03R\vunreadTotal\x12Q\n" +
	"\x11conversationElems\x18\x03 \x03(\v2#.fdim.conversation.ConversationElemR\x11conversationElems\"\xce\x01\n" +
	...
	"\bIsPinned\x18\x04 \x01(\bR\bIsPinned\x124\n" +
	"\amsgInfo\x18\x05 \x01(\v2\x1a.fdim.conversation.MsgInfoR\amsgInfo\"\x93\x04\n" +
	"\aMsgInfo\x12 \n" +
	...
	"\rconversations\x18\x02 \x03(\v2\x1f.fdim.conversation.ConversationR\rconversations\"9\n" +
	...
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs\"w\n" +
	"\x13SetConversationsReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\x12F\n" +
	"\fconversation\x18\x02 \x01(\v2\".fdim.conversation.ConversationReqR\fconversation\"\x16\n" +
	...
	"$GetConversationsByConversationIDResp\x12E\n" +
	"\rconversations\x18\x01 \x03(\v2\x1f.fdim.conversation.ConversationR\rconversations\"h\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xae\x06\n" +
	"\x15UpdateConversationReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x18\n" +
	"\auserIDs\x18\x02 \x03(\tR\auserIDs\x129\n" +
	"\n" +
	"recvMsgOpt\x18\x03 \x01(\v2\x19.fdim.protobuf.Int32ValueR\n" +
	"recvMsgOpt\x124\n" +
	"\bisPinned\x18\x04 \x01(\v2\x18.fdim.protobuf.BoolValueR\bisPinned\x12>\n" +
	"\fattachedInfo\x18\x05 \x01(\v2\x1a.fdim.protobuf.StringValueR\fattachedInfo\x12>\n" +
	"\risPrivateChat\x18\x06 \x01(\v2\x18.fdim.protobuf.BoolValueR\risPrivateChat\x12*\n" +
	"\x02ex\x18\a \x01(\v2\x1a.fdim.protobuf.StringValueR\x02ex\x12=\n" +
	"\fburnDuration\x18\b \x01(\v2\x19.fdim.protobuf.Int32ValueR\fburnDuration\x121\n" +
	"\x06minSeq\x18\t \x01(\v2\x19.fdim.protobuf.Int64ValueR\x06minSeq\x121\n" +
	"\x06maxSeq\x18\n" +
	" \x01(\v2\x19.fdim.protobuf.Int64ValueR\x06maxSeq\x12;\n" +
	"\vgroupAtType\x18\v \x01(\v2\x19.fdim.protobuf.Int32ValueR\vgroupAtType\x12C\n" +
	"\x0fmsgDestructTime\x18\f \x01(\v2\x19.fdim.protobuf.Int64ValueR\x0fmsgDestructTime\x12>\n" +
	"\risMsgDestruct\x18\r \x01(\v2\x18.fdim.protobuf.BoolValueR\risMsgDestruct\x12O\n" +
	"\x15latestMsgDestructTime\x18\x0e \x01(\v2\x19.fdim.protobuf.Int64ValueR\x15latestMsgDestructTime\"\x18\n" +
	...
	"\aversion\x18\x03 \x01(\x04R\aversion\"\xf6\x01\n" +
	...
	"\x06insert\x18\x05 \x03(\v2\x1f.fdim.conversation.ConversationR\x06insert\x127\n" +
	"\x06update\x18\x06 \x03(\v2\x1f.fdim.conversation.ConversationR\x06update\"p\n" +
	...
	"\rconversations\x18\x02 \x03(\v2\x1f.fdim.conversation.ConversationR\rconversations\"!\n" +
	"\x1fGetConversationsNeedClearMsgReq\"i\n" +
	" GetConversationsNeedClearMsgResp\x12E\n" +
	"\rconversations\x18\x01 \x03(\v2\x1f.fdim.conversation.ConversationR\rconversations\"8\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12*\n" +
	"\x02ex\x18\x02 \x01(\v2\x1a.fdim.protobuf.StringValueR\x02ex\"\x1f\n" +
	...
	"\x17DeleteConversationsResp2\xb6\x19\n" +
	"\fconversation\x12`\n" +
	"\x0fGetConversation\x12%.fdim.conversation.GetConversationReq\x1a&.fdim.conversation.GetConversationResp\x12~\n" +
	"\x19GetSortedConversationList\x12/.fdim.conversation.GetSortedConversationListReq\x1a0.fdim.conversation.GetSortedConversationListResp\x12l\n" +
	"\x13GetAllConversations\x12).fdim.conversation.GetAllConversationsReq\x1a*.fdim.conversation.GetAllConversationsResp\x12c\n" +
	"\x10GetConversations\x12&.fdim.conversation.GetConversationsReq\x1a'.fdim.conversation.GetConversationsResp\x12`\n" +
	"\x0fSetConversation\x12%.fdim.conversation.SetConversationReq\x1a&.fdim.conversation.SetConversationResp\x12\x81\x01\n" +
	"\x1aGetRecvMsgNotNotifyUserIDs\x120.fdim.conversation.GetRecvMsgNotNotifyUserIDsReq\x1a1.fdim.conversation.GetRecvMsgNotNotifyUserIDsResp\x12\x8a\x01\n" +
	"\x1dCreateSingleChatConversations\x123.fdim.conversation.CreateSingleChatConversationsReq\x1a4.fdim.conversation.CreateSingleChatConversationsResp\x12\x87\x01\n" +
	"\x1cCreateGroupChatConversations\x122.fdim.conversation.CreateGroupChatConversationsReq\x1a3.fdim.conversation.CreateGroupChatConversationsResp\x12r\n" +
	"\x15SetConversationMaxSeq\x12+.fdim.conversation.SetConversationMaxSeqReq\x1a,.fdim.conversation.SetConversationMaxSeqResp\x12r\n" +
	"\x15SetConversationMinSeq\x12+.fdim.conversation.SetConversationMinSeqReq\x1a,.fdim.conversation.SetConversationMinSeqResp\x12i\n" +
	"\x12GetConversationIDs\x12(.fdim.conversation.GetConversationIDsReq\x1a).fdim.conversation.GetConversationIDsResp\x12c\n" +
	"\x10SetConversations\x12&.fdim.conversation.SetConversationsReq\x1a'.fdim.conversation.SetConversationsResp\x12\x81\x01\n" +
	"\x1aGetUserConversationIDsHash\x120.fdim.conversation.GetUserConversationIDsHashReq\x1a1.fdim.conversation.GetUserConversationIDsHashResp\x12\x93\x01\n" +
	" GetConversationsByConversationID\x126.fdim.conversation.GetConversationsByConversationIDReq\x1a7.fdim.conversation.GetConversationsByConversationIDResp\x12\x96\x01\n" +
	"!GetConversationOfflinePushUserIDs\x127.fdim.conversation.GetConversationOfflinePushUserIDsReq\x1a8.fdim.conversation.GetConversationOfflinePushUserIDsResp\x12\xa8\x01\n" +
	"'GetConversationNotReceiveMessageUserIDs\x12=.fdim.conversation.GetConversationNotReceiveMessageUserIDsReq\x1a>.fdim.conversation.GetConversationNotReceiveMessageUserIDsResp\x12i\n" +
	"\x12UpdateConversation\x12(.fdim.conversation.UpdateConversationReq\x1a).fdim.conversation.UpdateConversationResp\x12\x84\x01\n" +
	"\x1bGetFullOwnerConversationIDs\x121.fdim.conversation.GetFullOwnerConversationIDsReq\x1a2.fdim.conversation.GetFullOwnerConversationIDsResp\x12\x81\x01\n" +
	"\x1aGetIncrementalConversation\x120.fdim.conversation.GetIncrementalConversationReq\x1a1.fdim.conversation.GetIncrementalConversationResp\x12o\n" +
	"\x14GetOwnerConversation\x12*.fdim.conversation.GetOwnerConversationReq\x1a+.fdim.conversation.GetOwnerConversationResp\x12\x87\x01\n" +
	"\x1cGetConversationsNeedClearMsg\x122.fdim.conversation.GetConversationsNeedClearMsgReq\x1a3.fdim.conversation.GetConversationsNeedClearMsgResp\x12\x84\x01\n" +
	"\x1bGetNotNotifyConversationIDs\x121.fdim.conversation.GetNotNotifyConversationIDsReq\x1a2.fdim.conversation.GetNotNotifyConversationIDsResp\x12{\n" +
	"\x18GetPinnedConversationIDs\x12..fdim.conversation.GetPinnedConversationIDsReq\x1a/.fdim.conversation.GetPinnedConversationIDsResp\x12{\n" +
	"\x18ClearUserConversationMsg\x12..fdim.conversation.ClearUserConversationMsgReq\x1a/.fdim.conversation.ClearUserConversationMsgResp\x12~\n" +
	"\x19UpdateConversationsByUser\x12/.fdim.conversation.UpdateConversationsByUserReq\x1a0.fdim.conversation.UpdateConversationsByUserResp\x12l\n" +
	"\x13DeleteConversations\x12).fdim.conversation.DeleteConversationsReq\x1a*.fdim.conversation.DeleteConversationsRespB\x1cZ\x1afdim/protocol/conversationb\x06proto3"
...
var file_conversation_conversation_proto_goTypes = []any{
	(*Conversation)(nil),                                // 0: fdim.conversation.Conversation
	(*ConversationReq)(nil),                             // 1: fdim.conversation.ConversationReq
	(*SetConversationReq)(nil),                          // 2: fdim.conversation.SetConversationReq
	(*SetConversationResp)(nil),                         // 3: fdim.conversation.SetConversationResp
	(*GetConversationReq)(nil),                          // 4: fdim.conversation.GetConversationReq
	(*GetConversationResp)(nil),                         // 5: fdim.conversation.GetConversationResp
	(*GetSortedConversationListReq)(nil),                // 6: fdim.conversation.GetSortedConversationListReq
	(*GetSortedConversationListResp)(nil),               // 7: fdim.conversation.GetSortedConversationListResp
	(*ConversationElem)(nil),                            // 8: fdim.conversation.ConversationElem
	(*MsgInfo)(nil),                                     // 9: fdim.conversation.MsgInfo
	(*GetConversationsReq)(nil),                         // 10: fdim.conversation.GetConversationsReq
	(*GetConversationsResp)(nil),                        // 11: fdim.conversation.GetConversationsResp
	(*GetAllConversationsReq)(nil),                      // 12: fdim.conversation.GetAllConversationsReq
	(*GetAllConversationsResp)(nil),                     // 13: fdim.conversation.GetAllConversationsResp
	(*GetRecvMsgNotNotifyUserIDsReq)(nil),               // 14: fdim.conversation.GetRecvMsgNotNotifyUserIDsReq
	(*GetRecvMsgNotNotifyUserIDsResp)(nil),              // 15: fdim.conversation.GetRecvMsgNotNotifyUserIDsResp
	(*CreateSingleChatConversationsReq)(nil),            // 16: fdim.conversation.CreateSingleChatConversationsReq
	(*CreateSingleChatConversationsResp)(nil),           // 17: fdim.conversation.CreateSingleChatConversationsResp
	(*CreateGroupChatConversationsReq)(nil),             // 18: fdim.conversation.CreateGroupChatConversationsReq
	(*CreateGroupChatConversationsResp)(nil),            // 19: fdim.conversation.CreateGroupChatConversationsResp
	(*SetConversationMaxSeqReq)(nil),                    // 20: fdim.conversation.SetConversationMaxSeqReq
	(*SetConversationMaxSeqResp)(nil),                   // 21: fdim.conversation.SetConversationMaxSeqResp
	(*SetConversationMinSeqReq)(nil),                    // 22: fdim.conversation.SetConversationMinSeqReq
	(*SetConversationMinSeqResp)(nil),                   // 23: fdim.conversation.SetConversationMinSeqResp
	(*GetConversationIDsReq)(nil),                       // 24: fdim.conversation.GetConversationIDsReq
	(*GetConversationIDsResp)(nil),                      // 25: fdim.conversation.GetConversationIDsResp
	(*SetConversationsReq)(nil),                         // 26: fdim.conversation.SetConversationsReq
	(*SetConversationsResp)(nil),                        // 27: fdim.conversation.SetConversationsResp
	(*GetUserConversationIDsHashReq)(nil),               // 28: fdim.conversation.GetUserConversationIDsHashReq
	(*GetUserConversationIDsHashResp)(nil),              // 29: fdim.conversation.GetUserConversationIDsHashResp
	(*GetConversationsByConversationIDReq)(nil),         // 30: fdim.conversation.GetConversationsByConversationIDReq
	(*GetConversationsByConversationIDResp)(nil),        // 31: fdim.conversation.GetConversationsByConversationIDResp
	(*GetConversationOfflinePushUserIDsReq)(nil),        // 32: fdim.conversation.GetConversationOfflinePushUserIDsReq
	(*GetConversationOfflinePushUserIDsResp)(nil),       // 33: fdim.conversation.GetConversationOfflinePushUserIDsResp
	(*GetConversationNotReceiveMessageUserIDsReq)(nil),  // 34: fdim.conversation.GetConversationNotReceiveMessageUserIDsReq
	(*GetConversationNotReceiveMessageUserIDsResp)(nil), // 35: fdim.conversation.GetConversationNotReceiveMessageUserIDsResp
	(*UpdateConversationReq)(nil),                       // 36: fdim.conversation.UpdateConversationReq
	(*UpdateConversationResp)(nil),                      // 37: fdim.conversation.UpdateConversationResp
	(*GetFullOwnerConversationIDsReq)(nil),              // 38: fdim.conversation.GetFullOwnerConversationIDsReq
	(*GetFullOwnerConversationIDsResp)(nil),             // 39: fdim.conversation.GetFullOwnerConversationIDsResp
	(*GetIncrementalConversationReq)(nil),               // 40: fdim.conversation.GetIncrementalConversationReq
	(*GetIncrementalConversationResp)(nil),              // 41: fdim.conversation.GetIncrementalConversationResp
	(*GetOwnerConversationReq)(nil),                     // 42: fdim.conversation.GetOwnerConversationReq
	(*GetOwnerConversationResp)(nil),                    // 43: fdim.conversation.GetOwnerConversationResp
	(*GetConversationsNeedClearMsgReq)(nil),             // 44: fdim.conversation.GetConversationsNeedClearMsgReq
	(*GetConversationsNeedClearMsgResp)(nil),            // 45: fdim.conversation.GetConversationsNeedClearMsgResp
	(*GetNotNotifyConversationIDsReq)(nil),              // 46: fdim.conversation.GetNotNotifyConversationIDsReq
	(*GetNotNotifyConversationIDsResp)(nil),             // 47: fdim.conversation.GetNotNotifyConversationIDsResp
	(*GetPinnedConversationIDsReq)(nil),                 // 48: fdim.conversation.GetPinnedConversationIDsReq
	(*GetPinnedConversationIDsResp)(nil),                // 49: fdim.conversation.GetPinnedConversationIDsResp
	(*ClearUserConversationMsgReq)(nil),                 // 50: fdim.conversation.ClearUserConversationMsgReq
	(*ClearUserConversationMsgResp)(nil),                // 51: fdim.conversation.ClearUserConversationMsgResp
	(*UpdateConversationsByUserReq)(nil),                // 52: fdim.conversation.UpdateConversationsByUserReq
	(*UpdateConversationsByUserResp)(nil),               // 53: fdim.conversation.UpdateConversationsByUserResp
	(*DeleteConversationsReq)(nil),                      // 54: fdim.conversation.DeleteConversationsReq
	(*DeleteConversationsResp)(nil),                     // 55: fdim.conversation.DeleteConversationsResp
	(*wrapperspb.Int32Value)(nil),                       // 56: fdim.protobuf.Int32Value
	(*wrapperspb.BoolValue)(nil),                        // 57: fdim.protobuf.BoolValue
	(*wrapperspb.StringValue)(nil),                      // 58: fdim.protobuf.StringValue
	(*wrapperspb.Int64Value)(nil),                       // 59: fdim.protobuf.Int64Value
	(*sdkws.RequestPagination)(nil),                     // 60: fdim.sdkws.RequestPagination
}
var file_conversation_conversation_proto_depIdxs = []int32{
	56, // 0: fdim.conversation.ConversationReq.recvMsgOpt:type_name -> fdim.protobuf.Int32Value
	57, // 1: fdim.conversation.ConversationReq.isPinned:type_name -> fdim.protobuf.BoolValue
	58, // 2: fdim.conversation.ConversationReq.attachedInfo:type_name -> fdim.protobuf.StringValue
	57, // 3: fdim.conversation.ConversationReq.isPrivateChat:type_name -> fdim.protobuf.BoolValue
	58, // 4: fdim.conversation.ConversationReq.ex:type_name -> fdim.protobuf.StringValue
	56, // 5: fdim.conversation.ConversationReq.burnDuration:type_name -> fdim.protobuf.Int32Value
	59, // 6: fdim.conversation.ConversationReq.minSeq:type_name -> fdim.protobuf.Int64Value
	59, // 7: fdim.conversation.ConversationReq.maxSeq:type_name -> fdim.protobuf.Int64Value
	56, // 8: fdim.conversation.ConversationReq.groupAtType:type_name -> fdim.protobuf.Int32Value
	59, // 9: fdim.conversation.ConversationReq.msgDestructTime:type_name -> fdim.protobuf.Int64Value
	57, // 10: fdim.conversation.ConversationReq.isMsgDestruct:type_name -> fdim.protobuf.BoolValue
	0,  // 11: fdim.conversation.SetConversationReq.conversation:type_name -> fdim.conversation.Conversation
	0,  // 12: fdim.conversation.GetConversationResp.conversation:type_name -> fdim.conversation.Conversation
	60, // 13: fdim.conversation.GetSortedConversationListReq.pagination:type_name -> fdim.sdkws.RequestPagination
	8,  // 14: fdim.conversation.GetSortedConversationListResp.conversationElems:type_name -> fdim.conversation.ConversationElem
	9,  // 15: fdim.conversation.ConversationElem.msgInfo:type_name -> fdim.conversation.MsgInfo
	0,  // 16: fdim.conversation.GetConversationsResp.conversations:type_name -> fdim.conversation.Conversation
	0,  // 17: fdim.conversation.GetAllConversationsResp.conversations:type_name -> fdim.conversation.Conversation
	1,  // 18: fdim.conversation.SetConversationsReq.conversation:type_name -> fdim.conversation.ConversationReq
	0,  // 19: fdim.conversation.GetConversationsByConversationIDResp.conversations:type_name -> fdim.conversation.Conversation
	56, // 20: fdim.conversation.UpdateConversationReq.recvMsgOpt:type_name -> fdim.protobuf.Int32Value
	57, // 21: fdim.conversation.UpdateConversationReq.isPinned:type_name -> fdim.protobuf.BoolValue
	58, // 22: fdim.conversation.UpdateConversationReq.attachedInfo:type_name -> fdim.protobuf.StringValue
	57, // 23: fdim.conversation.UpdateConversationReq.isPrivateChat:type_name -> fdim.protobuf.BoolValue
	58, // 24: fdim.conversation.UpdateConversationReq.ex:type_name -> fdim.protobuf.StringValue
	56, // 25: fdim.conversation.UpdateConversationReq.burnDuration:type_name -> fdim.protobuf.Int32Value
	59, // 26: fdim.conversation.UpdateConversationReq.minSeq:type_name -> fdim.protobuf.Int64Value
	59, // 27: fdim.conversation.UpdateConversationReq.maxSeq:type_name -> fdim.protobuf.Int64Value
	56, // 28: fdim.conversation.UpdateConversationReq.groupAtType:type_name -> fdim.protobuf.Int32Value
	59, // 29: fdim.conversation.UpdateConversationReq.msgDestructTime:type_name -> fdim.protobuf.Int64Value
	57, // 30: fdim.conversation.UpdateConversationReq.isMsgDestruct:type_name -> fdim.protobuf.BoolValue
	59, // 31: fdim.conversation.UpdateConversationReq.latestMsgDestructTime:type_name -> fdim.protobuf.Int64Value
	0,  // 32: fdim.conversation.GetIncrementalConversationResp.insert:type_name -> fdim.conversation.Conversation
	0,  // 33: fdim.conversation.GetIncrementalConversationResp.update:type_name -> fdim.conversation.Conversation
	60, // 34: fdim.conversation.GetOwnerConversationReq.pagination:type_name -> fdim.sdkws.RequestPagination
	0,  // 35: fdim.conversation.GetOwnerConversationResp.conversations:type_name -> fdim.conversation.Conversation
	0,  // 36: fdim.conversation.GetConversationsNeedClearMsgResp.conversations:type_name -> fdim.conversation.Conversation
	58, // 37: fdim.conversation.UpdateConversationsByUserReq.ex:type_name -> fdim.protobuf.StringValue
	4,  // 38: fdim.conversation.conversation.GetConversation:input_type -> fdim.conversation.GetConversationReq
	6,  // 39: fdim.conversation.conversation.GetSortedConversationList:input_type -> fdim.conversation.GetSortedConversationListReq
	12, // 40: fdim.conversation.conversation.GetAllConversations:input_type -> fdim.conversation.GetAllConversationsReq
	10, // 41: fdim.conversation.conversation.GetConversations:input_type -> fdim.conversation.GetConversationsReq
	2,  // 42: fdim.conversation.conversation.SetConversation:input_type -> fdim.conversation.SetConversationReq
	14, // 43: fdim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:input_type -> fdim.conversation.GetRecvMsgNotNotifyUserIDsReq
	16, // 44: fdim.conversation.conversation.CreateSingleChatConversations:input_type -> fdim.conversation.CreateSingleChatConversationsReq
	18, // 45: fdim.conversation.conversation.CreateGroupChatConversations:input_type -> fdim.conversation.CreateGroupChatConversationsReq
	20, // 46: fdim.conversation.conversation.SetConversationMaxSeq:input_type -> fdim.conversation.SetConversationMaxSeqReq
	22, // 47: fdim.conversation.conversation.SetConversationMinSeq:input_type -> fdim.conversation.SetConversationMinSeqReq
	24, // 48: fdim.conversation.conversation.GetConversationIDs:input_type -> fdim.conversation.GetConversationIDsReq
	26, // 49: fdim.conversation.conversation.SetConversations:input_type -> fdim.conversation.SetConversationsReq
	28, // 50: fdim.conversation.conversation.GetUserConversationIDsHash:input_type -> fdim.conversation.GetUserConversationIDsHashReq
	30, // 51: fdim.conversation.conversation.GetConversationsByConversationID:input_type -> fdim.conversation.GetConversationsByConversationIDReq
	32, // 52: fdim.conversation.conversation.GetConversationOfflinePushUserIDs:input_type -> fdim.conversation.GetConversationOfflinePushUserIDsReq
	34, // 53: fdim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:input_type -> fdim.conversation.GetConversationNotReceiveMessageUserIDsReq
	36, // 54: fdim.conversation.conversation.UpdateConversation:input_type -> fdim.conversation.UpdateConversationReq
	38, // 55: fdim.conversation.conversation.GetFullOwnerConversationIDs:input_type -> fdim.conversation.GetFullOwnerConversationIDsReq
	40, // 56: fdim.conversation.conversation.GetIncrementalConversation:input_type -> fdim.conversation.GetIncrementalConversationReq
	42, // 57: fdim.conversation.conversation.GetOwnerConversation:input_type -> fdim.conversation.GetOwnerConversationReq
	44, // 58: fdim.conversation.conversation.GetConversationsNeedClearMsg:input_type -> fdim.conversation.GetConversationsNeedClearMsgReq
	46, // 59: fdim.conversation.conversation.GetNotNotifyConversationIDs:input_type -> fdim.conversation.GetNotNotifyConversationIDsReq
	48, // 60: fdim.conversation.conversation.GetPinnedConversationIDs:input_type -> fdim.conversation.GetPinnedConversationIDsReq
	50, // 61: fdim.conversation.conversation.ClearUserConversationMsg:input_type -> fdim.conversation.ClearUserConversationMsgReq
	52, // 62: fdim.conversation.conversation.UpdateConversationsByUser:input_type -> fdim.conversation.UpdateConversationsByUserReq
	54, // 63: fdim.conversation.conversation.DeleteConversations:input_type -> fdim.conversation.DeleteConversationsReq
	5,  // 64: fdim.conversation.conversation.GetConversation:output_type -> fdim.conversation.GetConversationResp
	7,  // 65: fdim.conversation.conversation.GetSortedConversationList:output_type -> fdim.conversation.GetSortedConversationListResp
	13, // 66: fdim.conversation.conversation.GetAllConversations:output_type -> fdim.conversation.GetAllConversationsResp
	11, // 67: fdim.conversation.conversation.GetConversations:output_type -> fdim.conversation.GetConversationsResp
	3,  // 68: fdim.conversation.conversation.SetConversation:output_type -> fdim.conversation.SetConversationResp
	15, // 69: fdim.conversation.conversation.GetRecvMsgNotNotifyUserIDs:output_type -> fdim.conversation.GetRecvMsgNotNotifyUserIDsResp
	17, // 70: fdim.conversation.conversation.CreateSingleChatConversations:output_type -> fdim.conversation.CreateSingleChatConversationsResp
	19, // 71: fdim.conversation.conversation.CreateGroupChatConversations:output_type -> fdim.conversation.CreateGroupChatConversationsResp
	21, // 72: fdim.conversation.conversation.SetConversationMaxSeq:output_type -> fdim.conversation.SetConversationMaxSeqResp
	23, // 73: fdim.conversation.conversation.SetConversationMinSeq:output_type -> fdim.conversation.SetConversationMinSeqResp
	25, // 74: fdim.conversation.conversation.GetConversationIDs:output_type -> fdim.conversation.GetConversationIDsResp
	27, // 75: fdim.conversation.conversation.SetConversations:output_type -> fdim.conversation.SetConversationsResp
	29, // 76: fdim.conversation.conversation.GetUserConversationIDsHash:output_type -> fdim.conversation.GetUserConversationIDsHashResp
	31, // 77: fdim.conversation.conversation.GetConversationsByConversationID:output_type -> fdim.conversation.GetConversationsByConversationIDResp
	33, // 78: fdim.conversation.conversation.GetConversationOfflinePushUserIDs:output_type -> fdim.conversation.GetConversationOfflinePushUserIDsResp
	35, // 79: fdim.conversation.conversation.GetConversationNotReceiveMessageUserIDs:output_type -> fdim.conversation.GetConversationNotReceiveMessageUserIDsResp
	37, // 80: fdim.conversation.conversation.UpdateConversation:output_type -> fdim.conversation.UpdateConversationResp
	39, // 81: fdim.conversation.conversation.GetFullOwnerConversationIDs:output_type -> fdim.conversation.GetFullOwnerConversationIDsResp
	41, // 82: fdim.conversation.conversation.GetIncrementalConversation:output_type -> fdim.conversation.GetIncrementalConversationResp
	43, // 83: fdim.conversation.conversation.GetOwnerConversation:output_type -> fdim.conversation.GetOwnerConversationResp
	45, // 84: fdim.conversation.conversation.GetConversationsNeedClearMsg:output_type -> fdim.conversation.GetConversationsNeedClearMsgResp
	47, // 85: fdim.conversation.conversation.GetNotNotifyConversationIDs:output_type -> fdim.conversation.GetNotNotifyConversationIDsResp
	49, // 86: fdim.conversation.conversation.GetPinnedConversationIDs:output_type -> fdim.conversation.GetPinnedConversationIDsResp
	51, // 87: fdim.conversation.conversation.ClearUserConversationMsg:output_type -> fdim.conversation.ClearUserConversationMsgResp
	53, // 88: fdim.conversation.conversation.UpdateConversationsByUser:output_type -> fdim.conversation.UpdateConversationsByUserResp
	55, // 89: fdim.conversation.conversation.DeleteConversations:output_type -> fdim.conversation.DeleteConversationsResp
