...
const (
	Conversation_GetConversation_FullMethodName                         = "/fdim.conversation.conversation/GetConversation"
	Conversation_GetSortedConversationList_FullMethodName               = "/fdim.conversation.conversation/GetSortedConversationList"
	Conversation_GetAllConversations_FullMethodName                     = "/fdim.conversation.conversation/GetAllConversations"
	Conversation_GetConversations_FullMethodName                        = "/fdim.conversation.conversation/GetConversations"
	Conversation_SetConversation_FullMethodName                         = "/fdim.conversation.conversation/SetConversation"
	Conversation_GetRecvMsgNotNotifyUserIDs_FullMethodName              = "/fdim.conversation.conversation/GetRecvMsgNotNotifyUserIDs"
	Conversation_CreateSingleChatConversations_FullMethodName           = "/fdim.conversation.conversation/CreateSingleChatConversations"
	Conversation_CreateGroupChatConversations_FullMethodName            = "/fdim.conversation.conversation/CreateGroupChatConversations"
	Conversation_SetConversationMaxSeq_FullMethodName                   = "/fdim.conversation.conversation/SetConversationMaxSeq"
	Conversation_SetConversationMinSeq_FullMethodName                   = "/fdim.conversation.conversation/SetConversationMinSeq"
	Conversation_GetConversationIDs_FullMethodName                      = "/fdim.conversation.conversation/GetConversationIDs"
	Conversation_SetConversations_FullMethodName                        = "/fdim.conversation.conversation/SetConversations"
	Conversation_GetUserConversationIDsHash_FullMethodName              = "/fdim.conversation.conversation/GetUserConversationIDsHash"
	Conversation_GetConversationsByConversationID_FullMethodName        = "/fdim.conversation.conversation/GetConversationsByConversationID"
	Conversation_GetConversationOfflinePushUserIDs_FullMethodName       = "/fdim.conversation.conversation/GetConversationOfflinePushUserIDs"
	Conversation_GetConversationNotReceiveMessageUserIDs_FullMethodName = "/fdim.conversation.conversation/GetConversationNotReceiveMessageUserIDs"
	Conversation_UpdateConversation_FullMethodName                      = "/fdim.conversation.conversation/UpdateConversation"
	Conversation_GetFullOwnerConversationIDs_FullMethodName             = "/fdim.conversation.conversation/GetFullOwnerConversationIDs"
	Conversation_GetIncrementalConversation_FullMethodName              = "/fdim.conversation.conversation/GetIncrementalConversation"
	Conversation_GetOwnerConversation_FullMethodName                    = "/fdim.conversation.conversation/GetOwnerConversation"
	Conversation_GetConversationsNeedClearMsg_FullMethodName            = "/fdim.conversation.conversation/GetConversationsNeedClearMsg"
	Conversation_GetNotNotifyConversationIDs_FullMethodName             = "/fdim.conversation.conversation/GetNotNotifyConversationIDs"
	Conversation_GetPinnedConversationIDs_FullMethodName                = "/fdim.conversation.conversation/GetPinnedConversationIDs"
	Conversation_ClearUserConversationMsg_FullMethodName                = "/fdim.conversation.conversation/ClearUserConversationMsg"
	Conversation_UpdateConversationsByUser_FullMethodName               = "/fdim.conversation.conversation/UpdateConversationsByUser"
	Conversation_DeleteConversations_FullMethodName                     = "/fdim.conversation.conversation/DeleteConversations"
)
...
var Conversation_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "fdim.conversation.conversation",
