...
const file_push_push_proto_rawDesc = "" +
	"\n" +
	"\x0fpush/push.proto\x12\tfdim.push\x1a\x11sdkws/sdkws.proto\"}\n" +
	"\n" +
	"PushMsgReq\x12-\n" +
	...
	"platformID\"\x16\n" +
	"\x14DelUserPushTokenResp2\x9f\x01\n" +
	"\x0ePushMsgService\x128\n" +
	"\aPushMsg\x12\x15.fdim.push.PushMsgReq\x1a\x16.fdim.push.PushMsgResp\x12S\n" +
	"\x10DelUserPushToken\x12\x1e.fdim.push.DelUserPushTokenReq\x1a\x1f.fdim.push.DelUserPushTokenRespB\x14Z\x12fdim/protocol/pushb\x06proto3"
...
var file_push_push_proto_goTypes = []any{
	(*PushMsgReq)(nil),           // 0: fdim.push.PushMsgReq
	(*PushMsgResp)(nil),          // 1: fdim.push.PushMsgResp
	(*DelUserPushTokenReq)(nil),  // 2: fdim.push.DelUserPushTokenReq
	(*DelUserPushTokenResp)(nil), // 3: fdim.push.DelUserPushTokenResp
	(*sdkws.MsgData)(nil),        // 4: fdim.sdkws.MsgData
}
var file_push_push_proto_depIdxs = []int32{
	4, // 0: fdim.push.PushMsgReq.msgData:type_name -> fdim.sdkws.MsgData
	0, // 1: fdim.push.PushMsgService.PushMsg:input_type -> fdim.push.PushMsgReq
	2, // 2: fdim.push.PushMsgService.DelUserPushToken:input_type -> fdim.push.DelUserPushTokenReq
	1, // 3: fdim.push.PushMsgService.PushMsg:output_type -> fdim.push.PushMsgResp
	3, // 4: fdim.push.PushMsgService.DelUserPushToken:output_type -> fdim.push.DelUserPushTokenResp
