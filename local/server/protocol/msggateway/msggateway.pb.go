...
const file_msggateway_msggateway_proto_rawDesc = "" +
	"\n" +
	"\x1bmsggateway/msggateway.proto\x12\x0ffdim.msggateway\x1a\x11sdkws/sdkws.proto\"e\n" +
	"\x10OnlinePushMsgReq\x12-\n" +
	"\amsgData\x18\x01 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\x12\"\n" +
	"\fpushToUserID\x18\x02 \x01(\tR\fpushToUserID\"Q\n" +
	"\x11OnlinePushMsgResp\x12<\n" +
	"\x04resp\x18\x01 \x03(\v2(.fdim.msggateway.SingleMsgToUserPlatformR\x04resp\"\x8e\x01\n" +
	"\x16SingleMsgToUserResults\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12<\n" +
	"\x04resp\x18\x02 \x03(\v2(.fdim.msggateway.SingleMsgToUserPlatformR\x04resp\x12\x1e\n" +
	"\n" +
	"onlinePush\x18\x03 \x01(\bR\n" +
	"onlinePush\"o\n" +
	"\x18OnlineBatchPushOneMsgReq\x12-\n" +
	"\amsgData\x18\x01 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\x12$\n" +
	"\rpushToUserIDs\x18\x02 \x03(\tR\rpushToUserIDs\"p\n" +
	"\x19OnlineBatchPushOneMsgResp\x12S\n" +
	"\x10singlePushResult\x18\x01 \x03(\v2'.fdim.msggateway.SingleMsgToUserResultsR\x10singlePushResult\"y\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\xb0\x04\n" +
	"\x18GetUsersOnlineStatusResp\x12]\n" +
	"\rsuccessResult\x18\x01 \x03(\v27.fdim.msggateway.GetUsersOnlineStatusResp.SuccessResultR\rsuccessResult\x12Z\n" +
	"\ffailedResult\x18\x02 \x03(\v26.fdim.msggateway.GetUsersOnlineStatusResp.FailedDetailR\ffailedResult\x1a\x81\x01\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x1a\xac\x01\n" +
	"\rSuccessResult\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12k\n" +
	"\x14detailPlatformStatus\x18\x03 \x03(\v27.fdim.msggateway.GetUsersOnlineStatusResp.SuccessDetailR\x14detailPlatformStatus\"\x96\x01\n" +
	"\fSingleDetail\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x16\n" +
	"\x06status\x18\x02 \x01(\x05R\x06status\x12V\n" +
	"\x13singlePlatformToken\x18\x03 \x03(\v2$.fdim.msggateway.SinglePlatformTokenR\x13singlePlatformToken\"a\n" +
	...
	"\x1bMultiTerminalLoginCheckResp2\x8f\x05\n" +
	"\n" +
	"msgGateway\x12V\n" +
	"\rOnlinePushMsg\x12!.fdim.msggateway.OnlinePushMsgReq\x1a\".fdim.msggateway.OnlinePushMsgResp\x12k\n" +
	"\x14GetUsersOnlineStatus\x12(.fdim.msggateway.GetUsersOnlineStatusReq\x1a).fdim.msggateway.GetUsersOnlineStatusResp\x12n\n" +
	"\x15OnlineBatchPushOneMsg\x12).fdim.msggateway.OnlineBatchPushOneMsgReq\x1a*.fdim.msggateway.OnlineBatchPushOneMsgResp\x12x\n" +
	"\x1fSuperGroupOnlineBatchPushOneMsg\x12).fdim.msggateway.OnlineBatchPushOneMsgReq\x1a*.fdim.msggateway.OnlineBatchPushOneMsgResp\x12\\\n" +
	"\x0fKickUserOffline\x12#.fdim.msggateway.KickUserOfflineReq\x1a$.fdim.msggateway.KickUserOfflineResp\x12t\n" +
	"\x17MultiTerminalLoginCheck\x12+.fdim.msggateway.MultiTerminalLoginCheckReq\x1a,.fdim.msggateway.MultiTerminalLoginCheckRespB\x1aZ\x18fdim/protocol/msggatewayb\x06proto3"
...
var file_msggateway_msggateway_proto_goTypes = []any{
	(*OnlinePushMsgReq)(nil),                       // 0: fdim.msggateway.OnlinePushMsgReq
	(*OnlinePushMsgResp)(nil),                      // 1: fdim.msggateway.OnlinePushMsgResp
	(*SingleMsgToUserResults)(nil),                 // 2: fdim.msggateway.SingleMsgToUserResults
	(*OnlineBatchPushOneMsgReq)(nil),               // 3: fdim.msggateway.OnlineBatchPushOneMsgReq
	(*OnlineBatchPushOneMsgResp)(nil),              // 4: fdim.msggateway.OnlineBatchPushOneMsgResp
	(*SingleMsgToUserPlatform)(nil),                // 5: fdim.msggateway.SingleMsgToUserPlatform
	(*GetUsersOnlineStatusReq)(nil),                // 6: fdim.msggateway.GetUsersOnlineStatusReq
	(*GetUsersOnlineStatusResp)(nil),               // 7: fdim.msggateway.GetUsersOnlineStatusResp
	(*SingleDetail)(nil),                           // 8: fdim.msggateway.SingleDetail
	(*SinglePlatformToken)(nil),                    // 9: fdim.msggateway.SinglePlatformToken
	(*KickUserOfflineReq)(nil),                     // 10: fdim.msggateway.KickUserOfflineReq
	(*KickUserOfflineResp)(nil),                    // 11: fdim.msggateway.KickUserOfflineResp
	(*MultiTerminalLoginCheckReq)(nil),             // 12: fdim.msggateway.MultiTerminalLoginCheckReq
	(*MultiTerminalLoginCheckResp)(nil),            // 13: fdim.msggateway.MultiTerminalLoginCheckResp
	(*GetUsersOnlineStatusResp_SuccessDetail)(nil), // 14: fdim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	(*GetUsersOnlineStatusResp_FailedDetail)(nil),  // 15: fdim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	(*GetUsersOnlineStatusResp_SuccessResult)(nil), // 16: fdim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	(*sdkws.MsgData)(nil),                          // 17: fdim.sdkws.MsgData
}
var file_msggateway_msggateway_proto_depIdxs = []int32{
	17, // 0: fdim.msggateway.OnlinePushMsgReq.msgData:type_name -> fdim.sdkws.MsgData
	5,  // 1: fdim.msggateway.OnlinePushMsgResp.resp:type_name -> fdim.msggateway.SingleMsgToUserPlatform
	5,  // 2: fdim.msggateway.SingleMsgToUserResults.resp:type_name -> fdim.msggateway.SingleMsgToUserPlatform
	17, // 3: fdim.msggateway.OnlineBatchPushOneMsgReq.msgData:type_name -> fdim.sdkws.MsgData
	2,  // 4: fdim.msggateway.OnlineBatchPushOneMsgResp.singlePushResult:type_name -> fdim.msggateway.SingleMsgToUserResults
	16, // 5: fdim.msggateway.GetUsersOnlineStatusResp.successResult:type_name -> fdim.msggateway.GetUsersOnlineStatusResp.SuccessResult
	15, // 6: fdim.msggateway.GetUsersOnlineStatusResp.failedResult:type_name -> fdim.msggateway.GetUsersOnlineStatusResp.FailedDetail
	9,  // 7: fdim.msggateway.SingleDetail.singlePlatformToken:type_name -> fdim.msggateway.SinglePlatformToken
	14, // 8: fdim.msggateway.GetUsersOnlineStatusResp.SuccessResult.detailPlatformStatus:type_name -> fdim.msggateway.GetUsersOnlineStatusResp.SuccessDetail
	0,  // 9: fdim.msggateway.msgGateway.OnlinePushMsg:input_type -> fdim.msggateway.OnlinePushMsgReq
	6,  // 10: fdim.msggateway.msgGateway.GetUsersOnlineStatus:input_type -> fdim.msggateway.GetUsersOnlineStatusReq
	3,  // 11: fdim.msggateway.msgGateway.OnlineBatchPushOneMsg:input_type -> fdim.msggateway.OnlineBatchPushOneMsgReq
	3,  // 12: fdim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:input_type -> fdim.msggateway.OnlineBatchPushOneMsgReq
	10, // 13: fdim.msggateway.msgGateway.KickUserOffline:input_type -> fdim.msggateway.KickUserOfflineReq
	12, // 14: fdim.msggateway.msgGateway.MultiTerminalLoginCheck:input_type -> fdim.msggateway.MultiTerminalLoginCheckReq
	1,  // 15: fdim.msggateway.msgGateway.OnlinePushMsg:output_type -> fdim.msggateway.OnlinePushMsgResp
	7,  // 16: fdim.msggateway.msgGateway.GetUsersOnlineStatus:output_type -> fdim.msggateway.GetUsersOnlineStatusResp
	4,  // 17: fdim.msggateway.msgGateway.OnlineBatchPushOneMsg:output_type -> fdim.msggateway.OnlineBatchPushOneMsgResp
	4,  // 18: fdim.msggateway.msgGateway.SuperGroupOnlineBatchPushOneMsg:output_type -> fdim.msggateway.OnlineBatchPushOneMsgResp
	11, // 19: fdim.msggateway.msgGateway.KickUserOffline:output_type -> fdim.msggateway.KickUserOfflineResp
	13, // 20: fdim.msggateway.msgGateway.MultiTerminalLoginCheck:output_type -> fdim.msggateway.MultiTerminalLoginCheckResp
