...
type FindUserPublicInfoResp struct {
	state         protoimpl.MessageState      `protogen:"open.v1"`
	Users         []*sdkws.ChatUserPublicInfo `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SearchUserPublicInfoResp struct {
	...
	Users         []*sdkws.ChatUserPublicInfo `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type FindUserFullInfoResp struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Users         []*sdkws.ChatUserFullInfo `protobuf:"bytes,1,rep,name=users,proto3" json:"users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type SignalRecord struct {
	...
	InviterUserList []*sdkws.ChatUserPublicInfo `protobuf:"bytes,10,rep,name=inviterUserList,proto3" json:"inviterUserList,omitempty"`
...
type SearchUserFullInfoResp struct {
	state         protoimpl.MessageState    `protogen:"open.v1"`
	Total         uint32                    `protobuf:"varint,1,opt,name=total,proto3" json:"total,omitempty"`
	Users         []*sdkws.ChatUserFullInfo `protobuf:"bytes,2,rep,name=users,proto3" json:"users,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_chat_chat_proto_rawDesc = "" +
	"\n" +
	"\x0fchat/chat.proto\x12\vopenim.chat\x1a\x11sdkws/sdkws.proto\x1a\x1bwrapperspb/wrapperspb.proto\"\xb4\x01\n" +
	...
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"P\n" +
	"\x16FindUserPublicInfoResp\x126\n" +
	"\x05users\x18\x01 \x03(\v2 .openim.sdkws.ChatUserPublicInfoR\x05users\"\x8e\x01\n" +
	...
	"pagination\x12\x18\n" +
	"\agenders\x18\x03 \x01(\x05R\agenders\"h\n" +
	"\x18SearchUserPublicInfoResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\x126\n" +
	"\x05users\x18\x02 \x03(\v2 .openim.sdkws.ChatUserPublicInfoR\x05users\"/\n" +
	"\x13FindUserFullInfoReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"L\n" +
	"\x14FindUserFullInfoResp\x124\n" +
	"\x05users\x18\x01 \x03(\v2\x1e.openim.sdkws.ChatUserFullInfoR\x05users\"\xf1\x01\n" +
	...
	"\tgroupName\x18\t \x01(\tR\tgroupName\x12J\n" +
	"\x0finviterUserList\x18\n" +
	" \x03(\v2 .openim.sdkws.ChatUserPublicInfoR\x0finviterUserList\x12\x1a\n" +
	...
	"\x06normal\x18\x04 \x01(\x05R\x06normal\"d\n" +
	"\x16SearchUserFullInfoResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\rR\x05total\x124\n" +
	"\x05users\x18\x02 \x03(\v2\x1e.openim.sdkws.ChatUserFullInfoR\x05users\";\n" +
	...
	"\x05total\x18\x01 \x01(\rR\x05total\x124\n" +
	"\x05users\x18\x02 \x03(\v2\x1e.openim.sdkws.ChatUserFullInfoR\x05users\"L\n" +
	...
	"\x10GetAllowRegister\x12 .openim.chat.GetAllowRegisterReq\x1a!.openim.chat.GetAllowRegisterRespB\x14Z\x12fdim/protocol/chatb\x06proto3"
...
var file_chat_chat_proto_goTypes = []any{
	...
	(*sdkws.ChatUserPublicInfo)(nil),    // 53: openim.sdkws.ChatUserPublicInfo
	(*sdkws.RequestPagination)(nil),     // 54: openim.sdkws.RequestPagination
	(*sdkws.ChatUserFullInfo)(nil),      // 55: openim.sdkws.ChatUserFullInfo
}
var file_chat_chat_proto_depIdxs = []int32{
	...
	53, // 14: openim.chat.FindUserPublicInfoResp.users:type_name -> openim.sdkws.ChatUserPublicInfo
	54, // 15: openim.chat.SearchUserPublicInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	53, // 16: openim.chat.SearchUserPublicInfoResp.users:type_name -> openim.sdkws.ChatUserPublicInfo
	55, // 17: openim.chat.FindUserFullInfoResp.users:type_name -> openim.sdkws.ChatUserFullInfo
	...
	53, // 22: openim.chat.SignalRecord.inviterUserList:type_name -> openim.sdkws.ChatUserPublicInfo
	54, // 23: openim.chat.SearchUserFullInfoReq.pagination:type_name -> openim.sdkws.RequestPagination
	55, // 24: openim.chat.SearchUserFullInfoResp.users:type_name -> openim.sdkws.ChatUserFullInfo
	...
	55, // 27: openim.chat.SearchUserInfoResp.users:type_name -> openim.sdkws.ChatUserFullInfo
