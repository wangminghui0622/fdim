...
const (
	Chat_UpdateUserInfo_FullMethodName          = "/fdim.chat.chat/UpdateUserInfo"
	Chat_AddUserAccount_FullMethodName          = "/fdim.chat.chat/AddUserAccount"
	Chat_SearchUserPublicInfo_FullMethodName    = "/fdim.chat.chat/SearchUserPublicInfo"
	Chat_FindUserPublicInfo_FullMethodName      = "/fdim.chat.chat/FindUserPublicInfo"
	Chat_SearchUserFullInfo_FullMethodName      = "/fdim.chat.chat/SearchUserFullInfo"
	Chat_FindUserFullInfo_FullMethodName        = "/fdim.chat.chat/FindUserFullInfo"
	Chat_SendVerifyCode_FullMethodName          = "/fdim.chat.chat/SendVerifyCode"
	Chat_VerifyCode_FullMethodName              = "/fdim.chat.chat/VerifyCode"
	Chat_RegisterUser_FullMethodName            = "/fdim.chat.chat/RegisterUser"
	Chat_Login_FullMethodName                   = "/fdim.chat.chat/Login"
	Chat_ResetPassword_FullMethodName           = "/fdim.chat.chat/ResetPassword"
	Chat_ChangePassword_FullMethodName          = "/fdim.chat.chat/ChangePassword"
	Chat_CheckUserExist_FullMethodName          = "/fdim.chat.chat/CheckUserExist"
	Chat_DelUserAccount_FullMethodName          = "/fdim.chat.chat/DelUserAccount"
	Chat_FindUserAccount_FullMethodName         = "/fdim.chat.chat/FindUserAccount"
	Chat_FindAccountUser_FullMethodName         = "/fdim.chat.chat/FindAccountUser"
	Chat_FDIMCallback_FullMethodName            = "/fdim.chat.chat/FDIMCallback"
	Chat_UserLoginCount_FullMethodName          = "/fdim.chat.chat/UserLoginCount"
	Chat_SearchUserInfo_FullMethodName          = "/fdim.chat.chat/SearchUserInfo"
	Chat_GetTokenForVideoMeeting_FullMethodName = "/fdim.chat.chat/GetTokenForVideoMeeting"
	Chat_SetAllowRegister_FullMethodName        = "/fdim.chat.chat/SetAllowRegister"
	Chat_GetAllowRegister_FullMethodName        = "/fdim.chat.chat/GetAllowRegister"
)
...
type ChatClient interface {
	...
	FDIMCallback(ctx context.Context, in *FDIMCallbackReq, opts ...grpc.CallOption) (*FDIMCallbackResp, error)
	// Statistics
...
func (c *chatClient) FDIMCallback(ctx context.Context, in *FDIMCallbackReq, opts ...grpc.CallOption) (*FDIMCallbackResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FDIMCallbackResp)
	err := c.cc.Invoke(ctx, Chat_FDIMCallback_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServer interface {
	...
	FDIMCallback(context.Context, *FDIMCallbackReq) (*FDIMCallbackResp, error)
	// Statistics
...
func (UnimplementedChatServer) AddUserAccount(context.Context, *AddUserAccountReq) (*AddUserAccountResp, error) {
	return nil, status.Error(codes.Unimplemented, "method AddUserAccount not implemented")
}
func (UnimplementedChatServer) SearchUserPublicInfo(context.Context, *SearchUserPublicInfoReq) (*SearchUserPublicInfoResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SearchUserPublicInfo not implemented")
}
...
func (UnimplementedChatServer) FindUserFullInfo(context.Context, *FindUserFullInfoReq) (*FindUserFullInfoResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FindUserFullInfo not implemented")
}
...
func (UnimplementedChatServer) FindUserAccount(context.Context, *FindUserAccountReq) (*FindUserAccountResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FindUserAccount not implemented")
}
func (UnimplementedChatServer) FindAccountUser(context.Context, *FindAccountUserReq) (*FindAccountUserResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FindAccountUser not implemented")
}
func (UnimplementedChatServer) FDIMCallback(context.Context, *FDIMCallbackReq) (*FDIMCallbackResp, error) {
	return nil, status.Error(codes.Unimplemented, "method FDIMCallback not implemented")
}
func (UnimplementedChatServer) UserLoginCount(context.Context, *UserLoginCountReq) (*UserLoginCountResp, error) {
	return nil, status.Error(codes.Unimplemented, "method UserLoginCount not implemented")
}
...
func (UnimplementedChatServer) GetTokenForVideoMeeting(context.Context, *GetTokenForVideoMeetingReq) (*GetTokenForVideoMeetingResp, error) {
	return nil, status.Error(codes.Unimplemented, "method GetTokenForVideoMeeting not implemented")
}
func (UnimplementedChatServer) SetAllowRegister(context.Context, *SetAllowRegisterReq) (*SetAllowRegisterResp, error) {
	return nil, status.Error(codes.Unimplemented, "method SetAllowRegister not implemented")
}
...
func _Chat_FDIMCallback_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FDIMCallbackReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServer).FDIMCallback(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Chat_FDIMCallback_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServer).FDIMCallback(ctx, req.(*FDIMCallbackReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Chat_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FDIMCallback",
			Handler:    _Chat_FDIMCallback_Handler,
		},
		{
