...
const (
	Auth_GetAdminToken_FullMethodName    = "/fdim.auth.Auth/getAdminToken"
	Auth_GetUserToken_FullMethodName     = "/fdim.auth.Auth/getUserToken"
	Auth_ForceLogout_FullMethodName      = "/fdim.auth.Auth/forceLogout"
	Auth_ParseToken_FullMethodName       = "/fdim.auth.Auth/parseToken"
	Auth_InvalidateToken_FullMethodName  = "/fdim.auth.Auth/invalidateToken"
	Auth_KickTokens_FullMethodName       = "/fdim.auth.Auth/kickTokens"
	Auth_GetExistingToken_FullMethodName = "/fdim.auth.Auth/getExistingToken"
)
