...
const file_auth_auth_proto_rawDesc = "" +
	"\n" +
	"\x0fauth/auth.proto\x12\tfdim.auth\"B\n" +
	...
	"platformID\x18\x02 \x01(\x05R\n" +
	"platformID\"\xaa\x01\n" +
	"\x14getExistingTokenResp\x12R\n" +
	"\vtokenStates\x18\x01 \x03(\v20.fdim.auth.getExistingTokenResp.TokenStatesEntryR\vtokenStates\x1a>\n" +
	"\x10TokenStatesEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x05R\x05value:\x028\x012\x8e\x04\n" +
	"\x04Auth\x12J\n" +
	"\rgetAdminToken\x12\x1b.fdim.auth.getAdminTokenReq\x1a\x1c.fdim.auth.getAdminTokenResp\x12G\n" +
	"\fgetUserToken\x12\x1a.fdim.auth.getUserTokenReq\x1a\x1b.fdim.auth.getUserTokenResp\x12D\n" +
	"\vforceLogout\x12\x19.fdim.auth.forceLogoutReq\x1a\x1a.fdim.auth.forceLogoutResp\x12A\n" +
	"\n" +
	"parseToken\x12\x18.fdim.auth.parseTokenReq\x1a\x19.fdim.auth.parseTokenResp\x12P\n" +
	"\x0finvalidateToken\x12\x1d.fdim.auth.invalidateTokenReq\x1a\x1e.fdim.auth.invalidateTokenResp\x12A\n" +
	"\n" +
	"kickTokens\x12\x18.fdim.auth.kickTokensReq\x1a\x19.fdim.auth.kickTokensResp\x12S\n" +
	"\x10getExistingToken\x12\x1e.fdim.auth.GetExistingTokenReq\x1a\x1f.fdim.auth.getExistingTokenRespB\x14Z\x12fdim/protocol/authb\x06proto3"
...
var file_auth_auth_proto_goTypes = []any{
	(*GetAdminTokenReq)(nil),     // 0: fdim.auth.getAdminTokenReq
	(*GetAdminTokenResp)(nil),    // 1: fdim.auth.getAdminTokenResp
	(*ForceLogoutReq)(nil),       // 2: fdim.auth.forceLogoutReq
	(*ForceLogoutResp)(nil),      // 3: fdim.auth.forceLogoutResp
	(*ParseTokenReq)(nil),        // 4: fdim.auth.parseTokenReq
	(*ParseTokenResp)(nil),       // 5: fdim.auth.parseTokenResp
	(*GetUserTokenReq)(nil),      // 6: fdim.auth.getUserTokenReq
	(*GetUserTokenResp)(nil),     // 7: fdim.auth.getUserTokenResp
	(*InvalidateTokenReq)(nil),   // 8: fdim.auth.invalidateTokenReq
	(*InvalidateTokenResp)(nil),  // 9: fdim.auth.invalidateTokenResp
	(*KickTokensReq)(nil),        // 10: fdim.auth.kickTokensReq
	(*KickTokensResp)(nil),       // 11: fdim.auth.kickTokensResp
	(*GetExistingTokenReq)(nil),  // 12: fdim.auth.GetExistingTokenReq
	(*GetExistingTokenResp)(nil), // 13: fdim.auth.getExistingTokenResp
	nil,                          // 14: fdim.auth.getExistingTokenResp.TokenStatesEntry
}
var file_auth_auth_proto_depIdxs = []int32{
	14, // 0: fdim.auth.getExistingTokenResp.tokenStates:type_name -> fdim.auth.getExistingTokenResp.TokenStatesEntry
	0,  // 1: fdim.auth.Auth.getAdminToken:input_type -> fdim.auth.getAdminTokenReq
	6,  // 2: fdim.auth.Auth.getUserToken:input_type -> fdim.auth.getUserTokenReq
	2,  // 3: fdim.auth.Auth.forceLogout:input_type -> fdim.auth.forceLogoutReq
	4,  // 4: fdim.auth.Auth.parseToken:input_type -> fdim.auth.parseTokenReq
	8,  // 5: fdim.auth.Auth.invalidateToken:input_type -> fdim.auth.invalidateTokenReq
	10, // 6: fdim.auth.Auth.kickTokens:input_type -> fdim.auth.kickTokensReq
	12, // 7: fdim.auth.Auth.getExistingToken:input_type -> fdim.auth.GetExistingTokenReq
	1,  // 8: fdim.auth.Auth.getAdminToken:output_type -> fdim.auth.getAdminTokenResp
	7,  // 9: fdim.auth.Auth.getUserToken:output_type -> fdim.auth.getUserTokenResp
	3,  // 10: fdim.auth.Auth.forceLogout:output_type -> fdim.auth.forceLogoutResp
	5,  // 11: fdim.auth.Auth.parseToken:output_type -> fdim.auth.parseTokenResp
	9,  // 12: fdim.auth.Auth.invalidateToken:output_type -> fdim.auth.invalidateTokenResp
	11, // 13: fdim.auth.Auth.kickTokens:output_type -> fdim.auth.kickTokensResp
	13, // 14: fdim.auth.Auth.getExistingToken:output_type -> fdim.auth.getExistingTokenResp
