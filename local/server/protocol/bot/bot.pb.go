...
const file_bot_bot_proto_rawDesc = "" +
	"\n" +
	"\rbot/bot.proto\x12\bfdim.bot\x1a\x11sdkws/sdkws.proto\"\xe5\x01\n" +
	"\x05Agent\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x1a\n" +
	"\bnickname\x18\x02 \x01(\tR\bnickname\x12\x18\n" +
	"\afaceURL\x18\x03 \x01(\tR\afaceURL\x12\x10\n" +
	"\x03url\x18\x04 \x01(\tR\x03url\x12\x10\n" +
	"\x03key\x18\x05 \x01(\tR\x03key\x12\x1a\n" +
	"\bidentity\x18\x06 \x01(\tR\bidentity\x12\x14\n" +
	"\x05model\x18\a \x01(\tR\x05model\x12\x18\n" +
	"\aprompts\x18\b \x01(\tR\aprompts\x12\x1e\n" +
	"\n" +
	"createTime\x18\t \x01(\x03R\n" +
	"createTime\"7\n" +
	"\x0eCreateAgentReq\x12%\n" +
	"\x05agent\x18\x01 \x01(\v2\x0f.fdim.bot.AgentR\x05agent\"\x11\n" +
	"\x0fCreateAgentResp\"\xbd\x02\n" +
	"\x0eUpdateAgentReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12\x1f\n" +
	"\bnickname\x18\x02 \x01(\tH\x00R\bnickname\x88\x01\x01\x12\x1d\n" +
	"\afaceURL\x18\x03 \x01(\tH\x01R\afaceURL\x88\x01\x01\x12\x15\n" +
	"\x03url\x18\x04 \x01(\tH\x02R\x03url\x88\x01\x01\x12\x15\n" +
	"\x03key\x18\x05 \x01(\tH\x03R\x03key\x88\x01\x01\x12\x1f\n" +
	"\bidentity\x18\x06 \x01(\tH\x04R\bidentity\x88\x01\x01\x12\x19\n" +
	"\x05model\x18\a \x01(\tH\x05R\x05model\x88\x01\x01\x12\x1d\n" +
	"\aprompts\x18\b \x01(\tH\x06R\aprompts\x88\x01\x01B\v\n" +
	"\t_nicknameB\n" +
	"\n" +
	"\b_faceURLB\x06\n" +
	"\x04_urlB\x06\n" +
	...
	"\n" +
	"\b_prompts\"\x11\n" +
	"\x0fUpdateAgentResp\"k\n" +
	"\x10PageFindAgentReq\x12=\n" +
	"\n" +
	"pagination\x18\x01 \x01(\v2\x1d.fdim.sdkws.RequestPaginationR\n" +
	"pagination\x12\x18\n" +
	"\auserIDs\x18\x02 \x03(\tR\auserIDs\"R\n" +
	"\x11PageFindAgentResp\x12\x14\n" +
	"\x05total\x18\x01 \x01(\x03R\x05total\x12'\n" +
	"\x06agents\x18\x02 \x03(\v2\x0f.fdim.bot.AgentR\x06agents\"*\n" +
	"\x0eDeleteAgentReq\x12\x18\n" +
	"\auserIDs\x18\x01 \x03(\tR\auserIDs\"\x11\n" +
	"\x0fDeleteAgentResp\"\xb3\x01\n" +
	"\x11SendBotMessageReq\x12\x18\n" +
	...
	"\x02ex\x18\x05 \x01(\tR\x02ex\x12\x10\n" +
	"\x03key\x18\x06 \x01(\tR\x03key\"\x14\n" +
	"\x12SendBotMessageResp2\xe8\x02\n" +
	"\x03bot\x12B\n" +
	"\vCreateAgent\x12\x18.fdim.bot.CreateAgentReq\x1a\x19.fdim.bot.CreateAgentResp\x12B\n" +
	"\vUpdateAgent\x12\x18.fdim.bot.UpdateAgentReq\x1a\x19.fdim.bot.UpdateAgentResp\x12H\n" +
	"\rPageFindAgent\x12\x1a.fdim.bot.PageFindAgentReq\x1a\x1b.fdim.bot.PageFindAgentResp\x12B\n" +
	"\vDeleteAgent\x12\x18.fdim.bot.DeleteAgentReq\x1a\x19.fdim.bot.DeleteAgentResp\x12K\n" +
	"\x0eSendBotMessage\x12\x1b.fdim.bot.SendBotMessageReq\x1a\x1c.fdim.bot.SendBotMessageRespB\x13Z\x11fdim/protocol/botb\x06proto3"
...
var file_bot_bot_proto_goTypes = []any{
	(*Agent)(nil),                   // 0: fdim.bot.Agent
	(*CreateAgentReq)(nil),          // 1: fdim.bot.CreateAgentReq
	(*CreateAgentResp)(nil),         // 2: fdim.bot.CreateAgentResp
	(*UpdateAgentReq)(nil),          // 3: fdim.bot.UpdateAgentReq
	(*UpdateAgentResp)(nil),         // 4: fdim.bot.UpdateAgentResp
	(*PageFindAgentReq)(nil),        // 5: fdim.bot.PageFindAgentReq
	(*PageFindAgentResp)(nil),       // 6: fdim.bot.PageFindAgentResp
	(*DeleteAgentReq)(nil),          // 7: fdim.bot.DeleteAgentReq
	(*DeleteAgentResp)(nil),         // 8: fdim.bot.DeleteAgentResp
	(*SendBotMessageReq)(nil),       // 9: fdim.bot.SendBotMessageReq
	(*SendBotMessageResp)(nil),      // 10: fdim.bot.SendBotMessageResp
	(*sdkws.RequestPagination)(nil), // 11: fdim.sdkws.RequestPagination
}
var file_bot_bot_proto_depIdxs = []int32{
	0,  // 0: fdim.bot.CreateAgentReq.agent:type_name -> fdim.bot.Agent
	11, // 1: fdim.bot.PageFindAgentReq.pagination:type_name -> fdim.sdkws.RequestPagination
	0,  // 2: fdim.bot.PageFindAgentResp.agents:type_name -> fdim.bot.Agent
	1,  // 3: fdim.bot.bot.CreateAgent:input_type -> fdim.bot.CreateAgentReq
	3,  // 4: fdim.bot.bot.UpdateAgent:input_type -> fdim.bot.UpdateAgentReq
	5,  // 5: fdim.bot.bot.PageFindAgent:input_type -> fdim.bot.PageFindAgentReq
	7,  // 6: fdim.bot.bot.DeleteAgent:input_type -> fdim.bot.DeleteAgentReq
	9,  // 7: fdim.bot.bot.SendBotMessage:input_type -> fdim.bot.SendBotMessageReq
	2,  // 8: fdim.bot.bot.CreateAgent:output_type -> fdim.bot.CreateAgentResp
	4,  // 9: fdim.bot.bot.UpdateAgent:output_type -> fdim.bot.UpdateAgentResp
	6,  // 10: fdim.bot.bot.PageFindAgent:output_type -> fdim.bot.PageFindAgentResp
	8,  // 11: fdim.bot.bot.DeleteAgent:output_type -> fdim.bot.DeleteAgentResp
	10, // 12: fdim.bot.bot.SendBotMessage:output_type -> fdim.bot.SendBotMessageResp
