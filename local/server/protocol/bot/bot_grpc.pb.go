...
const (
	Bot_CreateAgent_FullMethodName    = "/fdim.bot.bot/CreateAgent"
	Bot_UpdateAgent_FullMethodName    = "/fdim.bot.bot/UpdateAgent"
	Bot_PageFindAgent_FullMethodName  = "/fdim.bot.bot/PageFindAgent"
	Bot_DeleteAgent_FullMethodName    = "/fdim.bot.bot/DeleteAgent"
	Bot_SendBotMessage_FullMethodName = "/fdim.bot.bot/SendBotMessage"
)
...
func (UnimplementedBotServer) PageFindAgent(context.Context, *PageFindAgentReq) (*PageFindAgentResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PageFindAgent not implemented")
}
