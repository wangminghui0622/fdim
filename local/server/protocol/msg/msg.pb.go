...
func (x *Seqs) GetPeerReadSeq() int64 {
	if x != nil {
		return x.PeerReadSeq
	}
	return 0
}
...
type GetSeqMessageReq struct {
	...
	Order         sdkws.PullOrder        `protobuf:"varint,3,opt,name=order,proto3,enum=fdim.sdkws.PullOrder" json:"order"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_msg_msg_proto_rawDesc = "" +
	"\n" +
	"\rmsg/msg.proto\x12\bfdim.msg\x1a\x1fconversation/conversation.proto\x1a\x11sdkws/sdkws.proto\"R\n" +
	"\vMsgDataToMQ\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12-\n" +
	"\amsgData\x18\x02 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\"<\n" +
	"\vMsgDataToDB\x12-\n" +
	"\amsgData\x18\x01 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\"h\n" +
	"\x0fPushMsgDataToMQ\x12-\n" +
	"\amsgData\x18\x01 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\"\x85\x01\n" +
	"\x12MsgDataToMongoByMQ\x12\x18\n" +
	"\alastSeq\x18\x01 \x01(\x03R\alastSeq\x12&\n" +
	"\x0econversationID\x18\x02 \x01(\tR\x0econversationID\x12-\n" +
	"\amsgData\x18\x03 \x03(\v2\x13.fdim.sdkws.MsgDataR\amsgData\",\n" +
	...
	"\n" +
	"SendMsgReq\x12-\n" +
	"\amsgData\x18\x03 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\"\x9a\x01\n" +
	"\vSendMsgResp\x12 \n" +
	...
	"\x06modify\x18\x04 \x01(\v2\x13.fdim.sdkws.MsgDataR\x06modify\"A\n" +
	"\x10SendSimpleMsgReq\x12-\n" +
	"\amsgData\x18\x03 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\"\xa0\x01\n" +
	"\x11SendSimpleMsgResp\x12 \n" +
	"\vserverMsgID\x18\x01 \x01(\tR\vserverMsgID\x12 \n" +
	"\vclientMsgID\x18\x02 \x01(\tR\vclientMsgID\x12\x1a\n" +
	"\bsendTime\x18\x03 \x01(\x03R\bsendTime\x12+\n" +
	"\x06modify\x18\x04 \x01(\v2\x13.fdim.sdkws.MsgDataR\x06modify\"-\n" +
	...
	"\x06status\x18\x01 \x01(\x05R\x06status\"n\n" +
	"\x13MsgDataToModifyByMQ\x12/\n" +
	"\bmessages\x18\x01 \x03(\v2\x13.fdim.sdkws.MsgDataR\bmessages\x12&\n" +
	...
	"IsSyncSelf\x12 \n" +
	"\vIsSyncOther\x18\x04 \x01(\bR\vIsSyncOther\"\x9b\x01\n" +
	...
	"\rdeleteSyncOpt\x18\x03 \x01(\v2\x17.fdim.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x1b\n" +
	"\x19ClearConversationsMsgResp\"k\n" +
	"\x12UserClearAllMsgReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12=\n" +
	"\rdeleteSyncOpt\x18\x03 \x01(\v2\x17.fdim.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x15\n" +
	"\x13UserClearAllMsgResp\"\xa2\x01\n" +
	"\rDeleteMsgsReq\x12&\n" +
	"\x0econversationID\x18\x01 \x01(\tR\x0econversationID\x12\x12\n" +
	"\x04seqs\x18\x02 \x03(\x03R\x04seqs\x12\x16\n" +
	"\x06userID\x18\x03 \x01(\tR\x06userID\x12=\n" +
	"\rdeleteSyncOpt\x18\x04 \x01(\v2\x17.fdim.msg.DeleteSyncOptR\rdeleteSyncOpt\"\x10\n" +
	"\x0eDeleteMsgsResp\"^\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12(\n" +
	"\x0fconversationIDs\x18\x02 \x03(\tR\x0fconversationIDs\"\x89\x01\n" +
	"\fSeqsInfoResp\x12=\n" +
	"\amaxSeqs\x18\x01 \x03(\v2#.fdim.msg.SeqsInfoResp.MaxSeqsEntryR\amaxSeqs\x1a:\n" +
	"\fMaxSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xcf\x01\n" +
	"\x1aGetMsgByConversationIDsReq\x12(\n" +
	"\x0fconversationIDs\x18\x01 \x03(\tR\x0fconversationIDs\x12K\n" +
	"\amaxSeqs\x18\x02 \x03(\v21.fdim.msg.GetMsgByConversationIDsReq.MaxSeqsEntryR\amaxSeqs\x1a:\n" +
	"\fMaxSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	"\x05value\x18\x02 \x01(\x03R\x05value:\x028\x01\"\xc0\x01\n" +
	"\x1bGetMsgByConversationIDsResp\x12O\n" +
	"\bmsgDatas\x18\x01 \x03(\v23.fdim.msg.GetMsgByConversationIDsResp.MsgDatasEntryR\bmsgDatas\x1aP\n" +
	"\rMsgDatasEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12)\n" +
	"\x05value\x18\x02 \x01(\v2\x13.fdim.sdkws.MsgDataR\x05value:\x028\x01\"B\n" +
	...
	"\tSeqsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12$\n" +
	"\x05value\x18\x02 \x01(\v2\x0e.fdim.msg.SeqsR\x05value:\x028\x01\"\xa1\x01\n" +
	...
	"\n" +
	"ActiveUser\x12(\n" +
	"\x04user\x18\x01 \x01(\v2\x14.fdim.sdkws.UserInfoR\x04user\x12\x14\n" +
	"\x05count\x18\x02 \x01(\x03R\x05count\"\x81\x02\n" +
	"\x11GetActiveUserResp\x12\x1a\n" +
	"\bmsgCount\x18\x01 \x01(\x03R\bmsgCount\x12\x1c\n" +
	"\tuserCount\x18\x02 \x01(\x03R\tuserCount\x12H\n" +
	"\tdateCount\x18\x03 \x03(\v2*.fdim.msg.GetActiveUserResp.DateCountEntryR\tdateCount\x12*\n" +
	"\x05users\x18\x04 \x03(\v2\x14.fdim.msg.ActiveUserR\x05users\x1a<\n" +
	...
	"\n" +
	"pagination\x18\x04 \x01(\v2\x1d.fdim.sdkws.RequestPaginationR\n" +
	"pagination\"P\n" +
	"\vActiveGroup\x12+\n" +
	"\x05group\x18\x01 \x01(\v2\x15.fdim.sdkws.GroupInfoR\x05group\x12\x14\n" +
	...
	"groupCount\x12I\n" +
	"\tdateCount\x18\x03 \x03(\v2+.fdim.msg.GetActiveGroupResp.DateCountEntryR\tdateCount\x12-\n" +
	"\x06groups\x18\x04 \x03(\v2\x15.fdim.msg.ActiveGroupR\x06groups\x1a<\n" +
	"\x0eDateCountEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\n" +
	"pagination\x18\x06 \x01(\v2\x1d.fdim.sdkws.RequestPaginationR\n" +
	"pagination\"Z\n" +
	"\rSearchChatLog\x12+\n" +
	"\achatLog\x18\x01 \x01(\v2\x11.fdim.msg.ChatLogR\achatLog\x12\x1c\n" +
	"\tisRevoked\x18\x02 \x01(\bR\tisRevoked\"^\n" +
	"\x0fSearchedMsgData\x12-\n" +
	"\amsgData\x18\x01 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\x12\x1c\n" +
	"\tisRevoked\x18\x02 \x01(\bR\tisRevoked\"j\n" +
	"\x11SearchMessageResp\x123\n" +
	"\bchatLogs\x18\x01 \x03(\v2\x17.fdim.msg.SearchChatLogR\bchatLogs\x12 \n" +
	...
	"groupOwner\x12\x1c\n" +
	"\tgroupType\x18\x17 \x01(\x05R\tgroupType\"d\n" +
	"\x13batchSendMessageReq\x12\x1e\n" +
	"\n" +
	"recvIDList\x18\x01 \x03(\tR\n" +
	"recvIDList\x12-\n" +
	"\amsgData\x18\x02 \x01(\v2\x13.fdim.sdkws.MsgDataR\amsgData\"\x16\n" +
	...
	"serverTime\"T\n" +
	"\vClearMsgReq\x12E\n" +
	"\rconversations\x18\x01 \x03(\v2\x1f.fdim.conversation.ConversationR\rconversations\"\x0e\n" +
	"\fClearMsgResp\"E\n" +
	...
	"\x04seqs\x18\x03 \x03(\x03R\x04seqs\"\x99\x01\n" +
	"\x10GetSeqMessageReq\x12\x16\n" +
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12@\n" +
	"\rconversations\x18\x02 \x03(\v2\x1a.fdim.msg.ConversationSeqsR\rconversations\x12+\n" +
	"\x05order\x18\x03 \x01(\x0e2\x15.fdim.sdkws.PullOrderR\x05order\"\xd7\x02\n" +
	"\x11GetSeqMessageResp\x129\n" +
	"\x04msgs\x18\x01 \x03(\v2%.fdim.msg.GetSeqMessageResp.MsgsEntryR\x04msgs\x12]\n" +
	"\x10notificationMsgs\x18\x02 \x03(\v21.fdim.msg.GetSeqMessageResp.NotificationMsgsEntryR\x10notificationMsgs\x1aM\n" +
	"\tMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.fdim.sdkws.PullMsgsR\x05value:\x028\x01\x1aY\n" +
	"\x15NotificationMsgsEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12*\n" +
	"\x05value\x18\x02 \x01(\v2\x14.fdim.sdkws.PullMsgsR\x05value:\x028\x01\"Z\n" +
	...
	"\x06maxSeq\x18\x03 \x01(\x03R\x06maxSeq\"_\n" +
	"\x19GetActiveConversationResp\x12B\n" +
	"\rconversations\x18\x01 \x03(\v2\x1c.fdim.msg.ActiveConversationR\rconversations\"\x80\x01\n" +
	...
	"\x06userID\x18\x01 \x01(\tR\x06userID\x12(\n" +
	"\x0fconversationIDs\x18\x02 \x03(\tR\x0fconversationIDs\"\x9e\x01\n" +
	...
	"\n" +
	"GetMaxSeqs\x12\x17.fdim.msg.GetMaxSeqsReq\x1a\x16.fdim.msg.SeqsInfoResp\x12E\n" +
	"\x0eGetHasReadSeqs\x12\x1b.fdim.msg.GetHasReadSeqsReq\x1a\x16.fdim.msg.SeqsInfoResp\x12f\n" +
	"\x17GetMsgByConversationIDs\x12$.fdim.msg.GetMsgByConversationIDsReq\x1a%.fdim.msg.GetMsgByConversationIDsResp\x12`\n" +
	"\x15GetConversationMaxSeq\x12\".fdim.msg.GetConversationMaxSeqReq\x1a#.fdim.msg.GetConversationMaxSeqResp\x12X\n" +
	"\x11PullMessageBySeqs\x12 .fdim.sdkws.PullMessageBySeqsReq\x1a!.fdim.sdkws.PullMessageBySeqsResp\x12H\n" +
	"\rGetSeqMessage\x12\x1a.fdim.msg.GetSeqMessageReq\x1a\x1b.fdim.msg.GetSeqMessageResp\x12H\n" +
	"\rSearchMessage\x12\x1a.fdim.msg.SearchMessageReq\x1a\x1b.fdim.msg.SearchMessageResp\x126\n" +
	"\aSendMsg\x12\x14.fdim.msg.SendMsgReq\x1a\x15.fdim.msg.SendMsgResp\x12H\n" +
	"\rSendSimpleMsg\x12\x1a.fdim.msg.SendSimpleMsgReq\x1a\x1b.fdim.msg.SendSimpleMsgResp\x12o\n" +
	"\x1aSetUserConversationsMinSeq\x12'.fdim.msg.SetUserConversationsMinSeqReq\x1a(.fdim.msg.SetUserConversationsMinSeqResp\x12`\n" +
	"\x15ClearConversationsMsg\x12\".fdim.msg.ClearConversationsMsgReq\x1a#.fdim.msg.ClearConversationsMsgResp\x12N\n" +
	"\x0fUserClearAllMsg\x12\x1c.fdim.msg.UserClearAllMsgReq\x1a\x1d.fdim.msg.UserClearAllMsgResp\x12?\n" +
	"\n" +
	"DeleteMsgs\x12\x17.fdim.msg.DeleteMsgsReq\x1a\x18.fdim.msg.DeleteMsgsResp\x12c\n" +
	"\x16DeleteMsgPhysicalBySeq\x12#.fdim.msg.DeleteMsgPhysicalBySeqReq\x1a$.fdim.msg.DeleteMsgPhysicalBySeqResp\x12T\n" +
	"\x11DeleteMsgPhysical\x12\x1e.fdim.msg.DeleteMsgPhysicalReq\x1a\x1f.fdim.msg.DeleteMsgPhysicalResp\x12Q\n" +
	"\x10SetSendMsgStatus\x12\x1d.fdim.msg.SetSendMsgStatusReq\x1a\x1e.fdim.msg.SetSendMsgStatusResp\x12Q\n" +
	"\x10GetSendMsgStatus\x12\x1d.fdim.msg.GetSendMsgStatusReq\x1a\x1e.fdim.msg.GetSendMsgStatusResp\x12<\n" +
	"\tRevokeMsg\x12\x16.fdim.msg.RevokeMsgReq\x1a\x17.fdim.msg.RevokeMsgResp\x12K\n" +
	"\x0eMarkMsgsAsRead\x12\x1b.fdim.msg.MarkMsgsAsReadReq\x1a\x1c.fdim.msg.MarkMsgsAsReadResp\x12c\n" +
	"\x16MarkConversationAsRead\x12#.fdim.msg.MarkConversationAsReadReq\x1a$.fdim.msg.MarkConversationAsReadResp\x12l\n" +
	"\x19SetConversationHasReadSeq\x12&.fdim.msg.SetConversationHasReadSeqReq\x1a'.fdim.msg.SetConversationHasReadSeqResp\x12\x81\x01\n" +
	" GetConversationsHasReadAndMaxSeq\x12-.fdim.msg.GetConversationsHasReadAndMaxSeqReq\x1a..fdim.msg.GetConversationsHasReadAndMaxSeqResp\x12H\n" +
	"\rGetActiveUser\x12\x1a.fdim.msg.GetActiveUserReq\x1a\x1b.fdim.msg.GetActiveUserResp\x12K\n" +
	"\x0eGetActiveGroup\x12\x1b.fdim.msg.GetActiveGroupReq\x1a\x1c.fdim.msg.GetActiveGroupResp\x12H\n" +
	"\rGetServerTime\x12\x1a.fdim.msg.GetServerTimeReq\x1a\x1b.fdim.msg.GetServerTimeResp\x129\n" +
	"\bClearMsg\x12\x15.fdim.msg.ClearMsgReq\x1a\x16.fdim.msg.ClearMsgResp\x12E\n" +
	"\fDestructMsgs\x12\x19.fdim.msg.DestructMsgsReq\x1a\x1a.fdim.msg.DestructMsgsResp\x12`\n" +
	"\x15GetActiveConversation\x12\".fdim.msg.GetActiveConversationReq\x1a#.fdim.msg.GetActiveConversationResp\x12l\n" +
...
var file_msg_msg_proto_goTypes = []any{
	...
	(*PushMsgDataToMQ)(nil),                      // 2: fdim.msg.PushMsgDataToMQ
	(*MsgDataToMongoByMQ)(nil),                   // 3: fdim.msg.MsgDataToMongoByMQ
	(*GetMaxAndMinSeqReq)(nil),                   // 4: fdim.msg.GetMaxAndMinSeqReq
	(*GetMaxAndMinSeqResp)(nil),                  // 5: fdim.msg.GetMaxAndMinSeqResp
	(*SendMsgReq)(nil),                           // 6: fdim.msg.SendMsgReq
	(*SendMsgResp)(nil),                          // 7: fdim.msg.SendMsgResp
	(*SendSimpleMsgReq)(nil),                     // 8: fdim.msg.SendSimpleMsgReq
	(*SendSimpleMsgResp)(nil),                    // 9: fdim.msg.SendSimpleMsgResp
	(*SetSendMsgStatusReq)(nil),                  // 10: fdim.msg.SetSendMsgStatusReq
	(*SetSendMsgStatusResp)(nil),                 // 11: fdim.msg.SetSendMsgStatusResp
	(*GetSendMsgStatusReq)(nil),                  // 12: fdim.msg.GetSendMsgStatusReq
	(*GetSendMsgStatusResp)(nil),                 // 13: fdim.msg.GetSendMsgStatusResp
	(*MsgDataToModifyByMQ)(nil),                  // 14: fdim.msg.MsgDataToModifyByMQ
	(*DelMsgsReq)(nil),                           // 15: fdim.msg.DelMsgsReq
	(*DelMsgsResp)(nil),                          // 16: fdim.msg.DelMsgsResp
	(*RevokeMsgReq)(nil),                         // 17: fdim.msg.RevokeMsgReq
	(*RevokeMsgResp)(nil),                        // 18: fdim.msg.RevokeMsgResp
	(*MarkMsgsAsReadReq)(nil),                    // 19: fdim.msg.MarkMsgsAsReadReq
	(*MarkMsgsAsReadResp)(nil),                   // 20: fdim.msg.MarkMsgsAsReadResp
	(*MarkConversationAsReadReq)(nil),            // 21: fdim.msg.MarkConversationAsReadReq
	(*MarkConversationAsReadResp)(nil),           // 22: fdim.msg.MarkConversationAsReadResp
	(*SetConversationHasReadSeqReq)(nil),         // 23: fdim.msg.SetConversationHasReadSeqReq
	(*SetConversationHasReadSeqResp)(nil),        // 24: fdim.msg.SetConversationHasReadSeqResp
	(*DeleteSyncOpt)(nil),                        // 25: fdim.msg.DeleteSyncOpt
	(*ClearConversationsMsgReq)(nil),             // 26: fdim.msg.ClearConversationsMsgReq
	(*ClearConversationsMsgResp)(nil),            // 27: fdim.msg.ClearConversationsMsgResp
	(*UserClearAllMsgReq)(nil),                   // 28: fdim.msg.UserClearAllMsgReq
	(*UserClearAllMsgResp)(nil),                  // 29: fdim.msg.UserClearAllMsgResp
	(*DeleteMsgsReq)(nil),                        // 30: fdim.msg.DeleteMsgsReq
	(*DeleteMsgsResp)(nil),                       // 31: fdim.msg.DeleteMsgsResp
	(*DeleteMsgPhysicalReq)(nil),                 // 32: fdim.msg.DeleteMsgPhysicalReq
	(*DeleteMsgPhysicalResp)(nil),                // 33: fdim.msg.DeleteMsgPhysicalResp
	(*DeleteMsgPhysicalBySeqReq)(nil),            // 34: fdim.msg.DeleteMsgPhysicalBySeqReq
	(*DeleteMsgPhysicalBySeqResp)(nil),           // 35: fdim.msg.DeleteMsgPhysicalBySeqResp
	(*GetMaxSeqsReq)(nil),                        // 36: fdim.msg.GetMaxSeqsReq
	(*GetHasReadSeqsReq)(nil),                    // 37: fdim.msg.GetHasReadSeqsReq
	(*SeqsInfoResp)(nil),                         // 38: fdim.msg.SeqsInfoResp
	(*GetMsgByConversationIDsReq)(nil),           // 39: fdim.msg.GetMsgByConversationIDsReq
	(*GetMsgByConversationIDsResp)(nil),          // 40: fdim.msg.GetMsgByConversationIDsResp
	(*GetConversationMaxSeqReq)(nil),             // 41: fdim.msg.GetConversationMaxSeqReq
	(*GetConversationMaxSeqResp)(nil),            // 42: fdim.msg.GetConversationMaxSeqResp
	(*GetConversationsHasReadAndMaxSeqReq)(nil),  // 43: fdim.msg.GetConversationsHasReadAndMaxSeqReq
	(*Seqs)(nil),                                 // 44: fdim.msg.Seqs
	(*GetConversationsHasReadAndMaxSeqResp)(nil), // 45: fdim.msg.GetConversationsHasReadAndMaxSeqResp
	(*GetActiveUserReq)(nil),                     // 46: fdim.msg.GetActiveUserReq
	(*ActiveUser)(nil),                           // 47: fdim.msg.ActiveUser
	(*GetActiveUserResp)(nil),                    // 48: fdim.msg.GetActiveUserResp
	(*GetActiveGroupReq)(nil),                    // 49: fdim.msg.GetActiveGroupReq
	(*ActiveGroup)(nil),                          // 50: fdim.msg.ActiveGroup
	(*GetActiveGroupResp)(nil),                   // 51: fdim.msg.GetActiveGroupResp
	(*SearchMessageReq)(nil),                     // 52: fdim.msg.SearchMessageReq
	(*SearchChatLog)(nil),                        // 53: fdim.msg.SearchChatLog
	(*SearchedMsgData)(nil),                      // 54: fdim.msg.SearchedMsgData
	(*SearchMessageResp)(nil),                    // 55: fdim.msg.SearchMessageResp
	(*ChatLog)(nil),                              // 56: fdim.msg.ChatLog
	(*BatchSendMessageReq)(nil),                  // 57: fdim.msg.batchSendMessageReq
	(*BatchSendMessageResp)(nil),                 // 58: fdim.msg.batchSendMessageResp
	(*GetServerTimeReq)(nil),                     // 59: fdim.msg.GetServerTimeReq
	(*GetServerTimeResp)(nil),                    // 60: fdim.msg.GetServerTimeResp
	(*ClearMsgReq)(nil),                          // 61: fdim.msg.ClearMsgReq
	(*ClearMsgResp)(nil),                         // 62: fdim.msg.ClearMsgResp
	(*DestructMsgsReq)(nil),                      // 63: fdim.msg.DestructMsgsReq
	(*DestructMsgsResp)(nil),                     // 64: fdim.msg.DestructMsgsResp
	(*SetUserConversationsMinSeqReq)(nil),        // 65: fdim.msg.SetUserConversationsMinSeqReq
	(*SetUserConversationsMinSeqResp)(nil),       // 66: fdim.msg.SetUserConversationsMinSeqResp
	(*ConversationSeqs)(nil),                     // 67: fdim.msg.ConversationSeqs
	(*GetSeqMessageReq)(nil),                     // 68: fdim.msg.GetSeqMessageReq
	(*GetSeqMessageResp)(nil),                    // 69: fdim.msg.GetSeqMessageResp
	(*GetActiveConversationReq)(nil),             // 70: fdim.msg.GetActiveConversationReq
	(*ActiveConversation)(nil),                   // 71: fdim.msg.ActiveConversation
	(*GetActiveConversationResp)(nil),            // 72: fdim.msg.GetActiveConversationResp
	(*SetUserConversationMaxSeqReq)(nil),         // 73: fdim.msg.SetUserConversationMaxSeqReq
	(*SetUserConversationMaxSeqResp)(nil),        // 74: fdim.msg.SetUserConversationMaxSeqResp
	(*SetUserConversationMinSeqReq)(nil),         // 75: fdim.msg.SetUserConversationMinSeqReq
	(*SetUserConversationMinSeqResp)(nil),        // 76: fdim.msg.SetUserConversationMinSeqResp
	(*GetLastMessageSeqByTimeReq)(nil),           // 77: fdim.msg.GetLastMessageSeqByTimeReq
...
var file_msg_msg_proto_depIdxs = []int32{
	...
	8,   // 50: fdim.msg.msg.SendSimpleMsg:input_type -> fdim.msg.SendSimpleMsgReq
	65,  // 51: fdim.msg.msg.SetUserConversationsMinSeq:input_type -> fdim.msg.SetUserConversationsMinSeqReq
	26,  // 52: fdim.msg.msg.ClearConversationsMsg:input_type -> fdim.msg.ClearConversationsMsgReq
	28,  // 53: fdim.msg.msg.UserClearAllMsg:input_type -> fdim.msg.UserClearAllMsgReq
	30,  // 54: fdim.msg.msg.DeleteMsgs:input_type -> fdim.msg.DeleteMsgsReq
	34,  // 55: fdim.msg.msg.DeleteMsgPhysicalBySeq:input_type -> fdim.msg.DeleteMsgPhysicalBySeqReq
	32,  // 56: fdim.msg.msg.DeleteMsgPhysical:input_type -> fdim.msg.DeleteMsgPhysicalReq
	10,  // 57: fdim.msg.msg.SetSendMsgStatus:input_type -> fdim.msg.SetSendMsgStatusReq
	12,  // 58: fdim.msg.msg.GetSendMsgStatus:input_type -> fdim.msg.GetSendMsgStatusReq
	17,  // 59: fdim.msg.msg.RevokeMsg:input_type -> fdim.msg.RevokeMsgReq
	19,  // 60: fdim.msg.msg.MarkMsgsAsRead:input_type -> fdim.msg.MarkMsgsAsReadReq
	21,  // 61: fdim.msg.msg.MarkConversationAsRead:input_type -> fdim.msg.MarkConversationAsReadReq
	23,  // 62: fdim.msg.msg.SetConversationHasReadSeq:input_type -> fdim.msg.SetConversationHasReadSeqReq
	43,  // 63: fdim.msg.msg.GetConversationsHasReadAndMaxSeq:input_type -> fdim.msg.GetConversationsHasReadAndMaxSeqReq
	46,  // 64: fdim.msg.msg.GetActiveUser:input_type -> fdim.msg.GetActiveUserReq
	49,  // 65: fdim.msg.msg.GetActiveGroup:input_type -> fdim.msg.GetActiveGroupReq
	59,  // 66: fdim.msg.msg.GetServerTime:input_type -> fdim.msg.GetServerTimeReq
	61,  // 67: fdim.msg.msg.ClearMsg:input_type -> fdim.msg.ClearMsgReq
	63,  // 68: fdim.msg.msg.DestructMsgs:input_type -> fdim.msg.DestructMsgsReq
	70,  // 69: fdim.msg.msg.GetActiveConversation:input_type -> fdim.msg.GetActiveConversationReq
	73,  // 70: fdim.msg.msg.SetUserConversationMaxSeq:input_type -> fdim.msg.SetUserConversationMaxSeqReq
