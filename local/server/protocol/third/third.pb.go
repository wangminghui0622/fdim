...
const file_third_third_proto_rawDesc = "" +
	"\n" +
	"\x11third/third.proto\x12\n" +
	"fdim.third\x1a\x11sdkws/sdkws.proto\"5\n" +
	"\tKeyValues\x12\x10\n" +
	...
	"\x05query\x18\x03 \x03(\v2\x15.fdim.third.KeyValuesR\x05query\x12-\n" +
	"\x06header\x18\x04 \x03(\v2\x15.fdim.third.KeyValuesR\x06header\"\xa9\x01\n" +
	"\rAuthSignParts\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12+\n" +
	"\x05query\x18\x02 \x03(\v2\x15.fdim.third.KeyValuesR\x05query\x12-\n" +
	"\x06header\x18\x03 \x03(\v2\x15.fdim.third.KeyValuesR\x06header\x12*\n" +
	"\x05parts\x18\x04 \x03(\v2\x14.fdim.third.SignPartR\x05parts\"\x0e\n" +
	"\fPartLimitReq\"s\n" +
	"\rPartLimitResp\x12 \n" +
	...
	"\turlPrefix\x18\b \x01(\tR\turlPrefix\"\x93\x01\n" +
	"\n" +
	"UploadInfo\x12\x1a\n" +
	"\buploadID\x18\x01 \x01(\tR\buploadID\x12\x1a\n" +
	"\bpartSize\x18\x02 \x01(\x03R\bpartSize\x12-\n" +
	"\x04sign\x18\x03 \x01(\v2\x19.fdim.third.AuthSignPartsR\x04sign\x12\x1e\n" +
	"\n" +
	"expireTime\x18\x04 \x01(\x03R\n" +
	"expireTime\"_\n" +
	"\x1bInitiateMultipartUploadResp\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12.\n" +
	"\x06upload\x18\x02 \x01(\v2\x16.fdim.third.UploadInfoR\x06upload\"K\n" +
	"\vAuthSignReq\x12\x1a\n" +
	"\buploadID\x18\x01 \x01(\tR\buploadID\x12 \n" +
	"\vpartNumbers\x18\x02 \x03(\x05R\vpartNumbers\"\xa8\x01\n" +
	"\fAuthSignResp\x12\x10\n" +
	"\x03url\x18\x01 \x01(\tR\x03url\x12+\n" +
	"\x05query\x18\x02 \x03(\v2\x15.fdim.third.KeyValuesR\x05query\x12-\n" +
	"\x06header\x18\x03 \x03(\v2\x15.fdim.third.KeyValuesR\x06header\x12*\n" +
	"\x05parts\x18\x04 \x03(\v2\x14.fdim.third.SignPartR\x05parts\"\xb8\x01\n" +
	...
	"\x05query\x18\x02 \x03(\v2#.fdim.third.AccessURLReq.QueryEntryR\x05query\x1a8\n" +
	"\n" +
	"QueryEntry\x12\x10\n" +
	...
	"\babsolute\x18\x06 \x01(\bR\babsolute\"\xc2\x02\n" +
	"\x14InitiateFormDataResp\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\tR\x02id\x12\x10\n" +
	"\x03url\x18\x02 \x01(\tR\x03url\x12\x12\n" +
	"\x04file\x18\x03 \x01(\tR\x04file\x12-\n" +
	"\x06header\x18\x04 \x03(\v2\x15.fdim.third.KeyValuesR\x06header\x12J\n" +
	"\bformData\x18\x05 \x03(\v2..fdim.third.InitiateFormDataResp.FormDataEntryR\bformData\x12\x18\n" +
	...
	"\x03URL\x18\x02 \x01(\tR\x03URL\"\xaa\x01\n" +
	"\rUploadLogsReq\x12\x1a\n" +
	"\bplatform\x18\x01 \x01(\x05R\bplatform\x12/\n" +
	"\bfileURLs\x18\x02 \x03(\v2\x13.fdim.third.fileURLR\bfileURLs\x12\"\n" +
	...
	"\aversion\x18\n" +
	" \x01(\tR\aversion\"Y\n" +
	"\x0eSearchLogsResp\x121\n" +
	"\tlogsInfos\x18\x01 \x03(\v2\x13.fdim.third.LogInfoR\tlogsInfos\x12\x14\n" +
	"\x05total\x18\x02 \x01(\rR\x05total2\xd4\b\n" +
	"\x05third\x12@\n" +
	"\tPartLimit\x12\x18.fdim.third.PartLimitReq\x1a\x19.fdim.third.PartLimitResp\x12=\n" +
	"\bPartSize\x12\x17.fdim.third.PartSizeReq\x1a\x18.fdim.third.PartSizeResp\x12j\n" +
	"\x17InitiateMultipartUpload\x12&.fdim.third.InitiateMultipartUploadReq\x1a'.fdim.third.InitiateMultipartUploadResp\x12=\n" +
	"\bAuthSign\x12\x17.fdim.third.AuthSignReq\x1a\x18.fdim.third.AuthSignResp\x12j\n" +
	"\x17CompleteMultipartUpload\x12&.fdim.third.CompleteMultipartUploadReq\x1a'.fdim.third.CompleteMultipartUploadResp\x12@\n" +
	"\tAccessURL\x12\x18.fdim.third.AccessURLReq\x1a\x19.fdim.third.AccessURLResp\x12U\n" +
	"\x10InitiateFormData\x12\x1f.fdim.third.InitiateFormDataReq\x1a .fdim.third.InitiateFormDataResp\x12U\n" +
	"\x10CompleteFormData\x12\x1f.fdim.third.CompleteFormDataReq\x1a .fdim.third.CompleteFormDataResp\x12[\n" +
	"\x12DeleteOutdatedData\x12!.fdim.third.DeleteOutdatedDataReq\x1a\".fdim.third.DeleteOutdatedDataResp\x12O\n" +
	"\x0eFcmUpdateToken\x12\x1d.fdim.third.FcmUpdateTokenReq\x1a\x1e.fdim.third.FcmUpdateTokenResp\x12F\n" +
	"\vSetAppBadge\x12\x1a.fdim.third.SetAppBadgeReq\x1a\x1b.fdim.third.SetAppBadgeResp\x12C\n" +
	"\n" +
	"UploadLogs\x12\x19.fdim.third.UploadLogsReq\x1a\x1a.fdim.third.UploadLogsResp\x12C\n" +
	"\n" +
	"DeleteLogs\x12\x19.fdim.third.DeleteLogsReq\x1a\x1a.fdim.third.DeleteLogsResp\x12C\n" +
	"\n" +
	"SearchLogs\x12\x19.fdim.third.SearchLogsReq\x1a\x1a.fdim.third.SearchLogsRespB\x15Z\x13fdim/protocol/thirdb\x06proto3"
...
var file_third_third_proto_goTypes = []any{
	(*KeyValues)(nil),                   // 0: fdim.third.KeyValues
	(*SignPart)(nil),                    // 1: fdim.third.SignPart
	(*AuthSignParts)(nil),               // 2: fdim.third.AuthSignParts
	(*PartLimitReq)(nil),                // 3: fdim.third.PartLimitReq
	(*PartLimitResp)(nil),               // 4: fdim.third.PartLimitResp
	(*PartSizeReq)(nil),                 // 5: fdim.third.PartSizeReq
	(*PartSizeResp)(nil),                // 6: fdim.third.PartSizeResp
	(*InitiateMultipartUploadReq)(nil),  // 7: fdim.third.InitiateMultipartUploadReq
	(*UploadInfo)(nil),                  // 8: fdim.third.UploadInfo
	(*InitiateMultipartUploadResp)(nil), // 9: fdim.third.InitiateMultipartUploadResp
	(*AuthSignReq)(nil),                 // 10: fdim.third.AuthSignReq
	(*AuthSignResp)(nil),                // 11: fdim.third.AuthSignResp
	(*CompleteMultipartUploadReq)(nil),  // 12: fdim.third.CompleteMultipartUploadReq
	(*CompleteMultipartUploadResp)(nil), // 13: fdim.third.CompleteMultipartUploadResp
	(*AccessURLReq)(nil),                // 14: fdim.third.AccessURLReq
	(*AccessURLResp)(nil),               // 15: fdim.third.AccessURLResp
	(*InitiateFormDataReq)(nil),         // 16: fdim.third.InitiateFormDataReq
	(*InitiateFormDataResp)(nil),        // 17: fdim.third.InitiateFormDataResp
	(*CompleteFormDataReq)(nil),         // 18: fdim.third.CompleteFormDataReq
	(*CompleteFormDataResp)(nil),        // 19: fdim.third.CompleteFormDataResp
	(*DeleteOutdatedDataReq)(nil),       // 20: fdim.third.DeleteOutdatedDataReq
	(*DeleteOutdatedDataResp)(nil),      // 21: fdim.third.DeleteOutdatedDataResp
	(*FcmUpdateTokenReq)(nil),           // 22: fdim.third.FcmUpdateTokenReq
	(*FcmUpdateTokenResp)(nil),          // 23: fdim.third.FcmUpdateTokenResp
	(*SetAppBadgeReq)(nil),              // 24: fdim.third.SetAppBadgeReq
	(*SetAppBadgeResp)(nil),             // 25: fdim.third.SetAppBadgeResp
	(*FileURL)(nil),                     // 26: fdim.third.fileURL
	(*UploadLogsReq)(nil),               // 27: fdim.third.UploadLogsReq
	(*UploadLogsResp)(nil),              // 28: fdim.third.UploadLogsResp
	(*DeleteLogsReq)(nil),               // 29: fdim.third.DeleteLogsReq
	(*DeleteLogsResp)(nil),              // 30: fdim.third.DeleteLogsResp
	(*SearchLogsReq)(nil),               // 31: fdim.third.SearchLogsReq
	(*LogInfo)(nil),                     // 32: fdim.third.LogInfo
	(*SearchLogsResp)(nil),              // 33: fdim.third.SearchLogsResp
	nil,                                 // 34: fdim.third.AccessURLReq.QueryEntry
	nil,                                 // 35: fdim.third.InitiateFormDataResp.FormDataEntry
	(*sdkws.RequestPagination)(nil),     // 36: fdim.sdkws.RequestPagination
}
var file_third_third_proto_depIdxs = []int32{
	0,  // 0: fdim.third.SignPart.query:type_name -> fdim.third.KeyValues
	0,  // 1: fdim.third.SignPart.header:type_name -> fdim.third.KeyValues
	0,  // 2: fdim.third.AuthSignParts.query:type_name -> fdim.third.KeyValues
	0,  // 3: fdim.third.AuthSignParts.header:type_name -> fdim.third.KeyValues
	1,  // 4: fdim.third.AuthSignParts.parts:type_name -> fdim.third.SignPart
	2,  // 5: fdim.third.UploadInfo.sign:type_name -> fdim.third.AuthSignParts
	8,  // 6: fdim.third.InitiateMultipartUploadResp.upload:type_name -> fdim.third.UploadInfo
	0,  // 7: fdim.third.AuthSignResp.query:type_name -> fdim.third.KeyValues
	0,  // 8: fdim.third.AuthSignResp.header:type_name -> fdim.third.KeyValues
	1,  // 9: fdim.third.AuthSignResp.parts:type_name -> fdim.third.SignPart
	34, // 10: fdim.third.AccessURLReq.query:type_name -> fdim.third.AccessURLReq.QueryEntry
	0,  // 11: fdim.third.InitiateFormDataResp.header:type_name -> fdim.third.KeyValues
	35, // 12: fdim.third.InitiateFormDataResp.formData:type_name -> fdim.third.InitiateFormDataResp.FormDataEntry
	26, // 13: fdim.third.UploadLogsReq.fileURLs:type_name -> fdim.third.fileURL
	36, // 14: fdim.third.SearchLogsReq.pagination:type_name -> fdim.sdkws.RequestPagination
	32, // 15: fdim.third.SearchLogsResp.logsInfos:type_name -> fdim.third.LogInfo
	3,  // 16: fdim.third.third.PartLimit:input_type -> fdim.third.PartLimitReq
	5,  // 17: fdim.third.third.PartSize:input_type -> fdim.third.PartSizeReq
	7,  // 18: fdim.third.third.InitiateMultipartUpload:input_type -> fdim.third.InitiateMultipartUploadReq
	10, // 19: fdim.third.third.AuthSign:input_type -> fdim.third.AuthSignReq
	12, // 20: fdim.third.third.CompleteMultipartUpload:input_type -> fdim.third.CompleteMultipartUploadReq
	14, // 21: fdim.third.third.AccessURL:input_type -> fdim.third.AccessURLReq
	16, // 22: fdim.third.third.InitiateFormData:input_type -> fdim.third.InitiateFormDataReq
	18, // 23: fdim.third.third.CompleteFormData:input_type -> fdim.third.CompleteFormDataReq
	20, // 24: fdim.third.third.DeleteOutdatedData:input_type -> fdim.third.DeleteOutdatedDataReq
	22, // 25: fdim.third.third.FcmUpdateToken:input_type -> fdim.third.FcmUpdateTokenReq
	24, // 26: fdim.third.third.SetAppBadge:input_type -> fdim.third.SetAppBadgeReq
	27, // 27: fdim.third.third.UploadLogs:input_type -> fdim.third.UploadLogsReq
	29, // 28: fdim.third.third.DeleteLogs:input_type -> fdim.third.DeleteLogsReq
	31, // 29: fdim.third.third.SearchLogs:input_type -> fdim.third.SearchLogsReq
	4,  // 30: fdim.third.third.PartLimit:output_type -> fdim.third.PartLimitResp
	6,  // 31: fdim.third.third.PartSize:output_type -> fdim.third.PartSizeResp
	9,  // 32: fdim.third.third.InitiateMultipartUpload:output_type -> fdim.third.InitiateMultipartUploadResp
	11, // 33: fdim.third.third.AuthSign:output_type -> fdim.third.AuthSignResp
	13, // 34: fdim.third.third.CompleteMultipartUpload:output_type -> fdim.third.CompleteMultipartUploadResp
	15, // 35: fdim.third.third.AccessURL:output_type -> fdim.third.AccessURLResp
	17, // 36: fdim.third.third.InitiateFormData:output_type -> fdim.third.InitiateFormDataResp
	19, // 37: fdim.third.third.CompleteFormData:output_type -> fdim.third.CompleteFormDataResp
	21, // 38: fdim.third.third.DeleteOutdatedData:output_type -> fdim.third.DeleteOutdatedDataResp
	23, // 39: fdim.third.third.FcmUpdateToken:output_type -> fdim.third.FcmUpdateTokenResp
	25, // 40: fdim.third.third.SetAppBadge:output_type -> fdim.third.SetAppBadgeResp
	28, // 41: fdim.third.third.UploadLogs:output_type -> fdim.third.UploadLogsResp
	30, // 42: fdim.third.third.DeleteLogs:output_type -> fdim.third.DeleteLogsResp
	33, // 43: fdim.third.third.SearchLogs:output_type -> fdim.third.SearchLogsResp
