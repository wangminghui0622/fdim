...
const (
	Admin_Login_FullMethodName                    = "/fdim.admin.admin/Login"
	Admin_ChangePassword_FullMethodName           = "/fdim.admin.admin/ChangePassword"
	Admin_AdminUpdateInfo_FullMethodName          = "/fdim.admin.admin/AdminUpdateInfo"
	Admin_GetAdminInfo_FullMethodName             = "/fdim.admin.admin/GetAdminInfo"
	Admin_AddAdminAccount_FullMethodName          = "/fdim.admin.admin/AddAdminAccount"
	Admin_ChangeAdminPassword_FullMethodName      = "/fdim.admin.admin/ChangeAdminPassword"
	Admin_DelAdminAccount_FullMethodName          = "/fdim.admin.admin/DelAdminAccount"
	Admin_SearchAdminAccount_FullMethodName       = "/fdim.admin.admin/SearchAdminAccount"
	Admin_AddDefaultFriend_FullMethodName         = "/fdim.admin.admin/AddDefaultFriend"
	Admin_DelDefaultFriend_FullMethodName         = "/fdim.admin.admin/DelDefaultFriend"
	Admin_FindDefaultFriend_FullMethodName        = "/fdim.admin.admin/FindDefaultFriend"
	Admin_SearchDefaultFriend_FullMethodName      = "/fdim.admin.admin/SearchDefaultFriend"
	Admin_AddDefaultGroup_FullMethodName          = "/fdim.admin.admin/AddDefaultGroup"
	Admin_DelDefaultGroup_FullMethodName          = "/fdim.admin.admin/DelDefaultGroup"
	Admin_FindDefaultGroup_FullMethodName         = "/fdim.admin.admin/FindDefaultGroup"
	Admin_SearchDefaultGroup_FullMethodName       = "/fdim.admin.admin/SearchDefaultGroup"
	Admin_AddInvitationCode_FullMethodName        = "/fdim.admin.admin/AddInvitationCode"
	Admin_GenInvitationCode_FullMethodName        = "/fdim.admin.admin/GenInvitationCode"
	Admin_FindInvitationCode_FullMethodName       = "/fdim.admin.admin/FindInvitationCode"
	Admin_UseInvitationCode_FullMethodName        = "/fdim.admin.admin/UseInvitationCode"
	Admin_DelInvitationCode_FullMethodName        = "/fdim.admin.admin/DelInvitationCode"
	Admin_SearchInvitationCode_FullMethodName     = "/fdim.admin.admin/SearchInvitationCode"
	Admin_SearchUserIPLimitLogin_FullMethodName   = "/fdim.admin.admin/SearchUserIPLimitLogin"
	Admin_AddUserIPLimitLogin_FullMethodName      = "/fdim.admin.admin/AddUserIPLimitLogin"
	Admin_DelUserIPLimitLogin_FullMethodName      = "/fdim.admin.admin/DelUserIPLimitLogin"
	Admin_SearchIPForbidden_FullMethodName        = "/fdim.admin.admin/SearchIPForbidden"
	Admin_AddIPForbidden_FullMethodName           = "/fdim.admin.admin/AddIPForbidden"
	Admin_DelIPForbidden_FullMethodName           = "/fdim.admin.admin/DelIPForbidden"
	Admin_CancellationUser_FullMethodName         = "/fdim.admin.admin/CancellationUser"
	Admin_BlockUser_FullMethodName                = "/fdim.admin.admin/BlockUser"
	Admin_UnblockUser_FullMethodName              = "/fdim.admin.admin/UnblockUser"
	Admin_SearchBlockUser_FullMethodName          = "/fdim.admin.admin/SearchBlockUser"
	Admin_FindUserBlockInfo_FullMethodName        = "/fdim.admin.admin/FindUserBlockInfo"
	Admin_CheckRegisterForbidden_FullMethodName   = "/fdim.admin.admin/CheckRegisterForbidden"
	Admin_CheckLoginForbidden_FullMethodName      = "/fdim.admin.admin/CheckLoginForbidden"
	Admin_CreateToken_FullMethodName              = "/fdim.admin.admin/CreateToken"
	Admin_ParseToken_FullMethodName               = "/fdim.admin.admin/ParseToken"
	Admin_AddApplet_FullMethodName                = "/fdim.admin.admin/AddApplet"
	Admin_DelApplet_FullMethodName                = "/fdim.admin.admin/DelApplet"
	Admin_UpdateApplet_FullMethodName             = "/fdim.admin.admin/UpdateApplet"
	Admin_FindApplet_FullMethodName               = "/fdim.admin.admin/FindApplet"
	Admin_SearchApplet_FullMethodName             = "/fdim.admin.admin/SearchApplet"
	Admin_GetClientConfig_FullMethodName          = "/fdim.admin.admin/GetClientConfig"
	Admin_SetClientConfig_FullMethodName          = "/fdim.admin.admin/SetClientConfig"
	Admin_DelClientConfig_FullMethodName          = "/fdim.admin.admin/DelClientConfig"
	Admin_GetUserToken_FullMethodName             = "/fdim.admin.admin/GetUserToken"
	Admin_InvalidateToken_FullMethodName          = "/fdim.admin.admin/InvalidateToken"
	Admin_LatestApplicationVersion_FullMethodName = "/fdim.admin.admin/LatestApplicationVersion"
	Admin_AddApplicationVersion_FullMethodName    = "/fdim.admin.admin/AddApplicationVersion"
	Admin_UpdateApplicationVersion_FullMethodName = "/fdim.admin.admin/UpdateApplicationVersion"
	Admin_DeleteApplicationVersion_FullMethodName = "/fdim.admin.admin/DeleteApplicationVersion"
	Admin_PageApplicationVersion_FullMethodName   = "/fdim.admin.admin/PageApplicationVersion"
)
...
func (UnimplementedAdminServer) LatestApplicationVersion(context.Context, *LatestApplicationVersionReq) (*LatestApplicationVersionResp, error) {
	return nil, status.Error(codes.Unimplemented, "method LatestApplicationVersion not implemented")
}
func (UnimplementedAdminServer) AddApplicationVersion(context.Context, *AddApplicationVersionReq) (*AddApplicationVersionResp, error) {
	return nil, status.Error(codes.Unimplemented, "method AddApplicationVersion not implemented")
}
...
func (UnimplementedAdminServer) PageApplicationVersion(context.Context, *PageApplicationVersionReq) (*PageApplicationVersionResp, error) {
	return nil, status.Error(codes.Unimplemented, "method PageApplicationVersion not implemented")
}
