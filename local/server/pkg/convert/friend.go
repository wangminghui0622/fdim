...
import (
	...
	"fdim/pkg/notification/common_user"
...
func FriendOnlyDB2PbOnly(friendsDB []*model.Friend) []*user.FriendInfoOnly {
	return datautil.Slice(friendsDB, func(f *model.Friend) *user.FriendInfoOnly {
		return &user.FriendInfoOnly{
