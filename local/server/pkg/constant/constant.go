...
// Context Key 常量
const (
	// CtxOpUserIDKey Context 中操作用户ID的键
	CtxOpUserIDKey = "OpUserID"
	// CtxAdminUserIDsKey Context 中管理员用户ID列表的键
	CtxAdminUserIDsKey = "CtxAdminUserIDsKey"
	// CtxOperationIDKey Context 中操作ID的键
	CtxOperationIDKey = "OperationID"
