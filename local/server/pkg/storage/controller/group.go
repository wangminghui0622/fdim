...
import (
	...
	"fdim/pkg/config"
	redis2 "fdim/pkg/storage/cache/redis"
	"fdim/pkg/storage/common"
...
type GroupDatabase interface {
	...
	// FindGroupMemberRoleLevels retrieves group members filtered by their role levels within a user.
	FindGroupMemberRoleLevels(ctx context.Context, groupID string, roleLevels []int32) (groupMembers []*model.GroupMember, err error)
	// FindGroupMemberAll retrieves all members of a user.
	...
	// FindGroupMemberUserID retrieves the user IDs of all members in a user.
	FindGroupMemberUserID(ctx context.Context, groupID string) ([]string, error)
	// FindGroupMemberNum retrieves the number of members in a user.
	...
	// PageGetGroupMember paginates through members of a user.
	...
	// DeleteGroupMember removes specified users from a user.
