class MessageType {
  ...
  static const hasReadReceipt = 2200; // Read receipt notification (matches backend constant.HasReadReceipt)

  static bool isNotificationType(int? contentType) =>
      contentType != null && contentType > notificationBegin;
}
